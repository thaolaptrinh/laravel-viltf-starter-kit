(() => {
            ...
            if ((n && typeof n == 'object') || typeof n == 'function')
                for (let a of oe(n))
                    !ie.call(t, a) &&
                        ...
                        K(t, a, {
                            get: () => n[a],
                            enumerable: !(i = ae(n, a)) || i.enumerable,
                        });
            return t;
        },
        ce = (t) =>
        ...
        ue = le((t, n) => {
            (function (i, a, w) {
                ...
                for (
                    ...
                    c[111 + m] = 'f' + m;
                for (m = 0; m <= 9; ++m) c[m + 96] = m.toString();
                function P(e, r, s) {
                ...
                function G(e, r) {
                    ...
                    for (s = Q(e), k = 0; k < s.length; ++k)
                        ((h = s[k]),
                            ...
                            E(h) && M.push(h));
                    return (
                        (r = Y(h, M, r)), { key: h, modifiers: M, action: r }
                    );
                }
                function R(e, r) {
                    return e === null || e === a
                ...
                function g(e) {
                    var r = this;
                    if (((e = e || a), !(r instanceof g))) return new g(e);
                    ...
                    function I(o, f, p, l, d, b) {
                        var u,
                            _,
                            C = [],
                            O = p.type;
                        if (!r._callbacks[o]) return [];
                        for (
                            O == 'keyup' && E(o) && (f = [o]), u = 0;
                            u < r._callbacks[o].length;
                            ++u
                        )
                            if (
                                ((_ = r._callbacks[o][u]),
                                !(!l && _.seq && s[_.seq] != _.level) &&
                                    O == _.action &&
                                    ((O == 'keypress' &&
                                        !p.metaKey &&
                                        !p.ctrlKey) ||
                                ...
                                var ee = !l && _.combo == d,
                                    te = l && _.seq == l && _.level == b;
                                ((ee || te) && r._callbacks[o].splice(u, 1),
                                    C.push(_));
                            }
                        return C;
                    }
                    function q(o, f, p, l) {
                        r.stopCallback(f, f.target || f.srcElement, p, l) ||
                            (o(f, p) === !1 && (H(f), B(f)));
                    }
                    r._handleKey = function (o, f, p) {
                        var l = I(o, f, p),
                            d,
                            b = {},
                            u = 0,
                        ...
                        for (d = 0; d < l.length; ++d) {
                            if (l[d].seq) {
                                ...
                                ((_ = !0),
                                    (b[l[d].seq] = 1),
                                    q(l[d].callback, p, l[d].combo, l[d].seq));
                                continue;
                            }
                            _ || q(l[d].callback, p, l[d].combo);
                        }
                        var C = p.type == 'keypress' && M;
                        (p.type == D && !E(o) && !C && L(b),
                            (M = _ && p.type == 'keydown'));
                    };
                    function T(o) {
                        typeof o.which != 'number' && (o.which = o.keyCode);
                        var f = U(o);
                        if (f) {
                            if (o.type == 'keyup' && k === f) {
                                k = !1;
                    ...
                    function Z() {
                        (clearTimeout(h), (h = setTimeout(L, 1e3)));
                    }
                    function $(o, f, p, l) {
                        s[o] = 0;
                        function d(O) {
                        ...
                        for (var u = 0; u < f.length; ++u) {
                            var _ = u + 1 === f.length,
                                C = _ ? b : d(l || G(f[u + 1]).action);
                            z(f[u], C, l, o, u);
                        }
                    }
                    function z(o, f, p, l, d) {
                        ((r._directMap[o + ':' + p] = f),
                            (o = o.replace(/\s+/g, ' ')));
                        var b = o.split(' '),
                            u;
                        ...
                        ((u = G(o, p)),
                            ...
                            I(u.key, u.modifiers, { type: u.action }, l, o, d),
                    ...
                    ((r._bindMultiple = function (o, f, p) {
                        for (var l = 0; l < o.length; ++l) z(o[l], f, p);
                    }),
                        P(e, 'keypress', T),
                        P(e, 'keydown', T),
                        P(e, 'keyup', T));
                }
                ((g.prototype.bind = function (e, r, s) {
                    var h = this;
                    return (
                    ...
                    (g.prototype.unbind = function (e, r) {
                        var s = this;
                        return s.bind.call(s, e, function () {}, r);
                    }),
                    (g.prototype.trigger = function (e, r) {
                        var s = this;
                        return (
                            s._directMap[e + ':' + r] &&
                                s._directMap[e + ':' + r]({}, e),
                    ...
                    (g.prototype.stopCallback = function (e, r) {
                        var s = this;
                        if (
                    ...
                    g.init(),
                    (i.Mousetrap = g),
                    typeof n < 'u' && n.exports && (n.exports = g),
    ...
    (function (t) {
        if (t) {
            ...
            ((t.prototype.stopCallback = function (a, w, c, y) {
                var v = this;
                return v.paused ? !0 : n[c] || n[y] ? !1 : i.call(v, a, w, c);
            }),
                (t.prototype.bindGlobal = function (a, w, c) {
                    var y = this;
                    if ((y.bind(a, w, c), a instanceof Array)) {
                        for (var v = 0; v < a.length; v++) n[a[v]] = !0;
                        return;
                    }
                    n[a] = !0;
                }),
    ...
    var W = () =>
        ...
        pe = (t) => {
            t.directive(
                'mousetrap',
                (n, { modifiers: i, expression: a }, { evaluate: w }) => {
                    let c = () => (a ? w(a) : n.click());
                    ((i = i.map((y) =>
                        y
                            .replace(/--/g, ' ')
                        ...
                        i.includes('global') &&
                            ((i = i.filter((y) => y !== 'global')),
                            N.default.bindGlobal(i, (y) => {
                                let v = W();
                                (v && !v.contains(n)) ||
                                    (y.preventDefault(), c());
                            })),
                        N.default.bind(i, (y) => {
                            let v = W();
                            (v && !v.contains(n)) || (y.preventDefault(), c());
                        }),
        ...
        setUpResizeObserver() {
            ...
            ((this.resizeObserver = new ResizeObserver(() => {
                ...
                (i && a
                    ...
                    : !i && w && (this.isOpen = this.isOpenDesktop),
                    (t = n));
            })),
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.interceptRequest(
            ({ request: t, onError: n, onFailure: i }) => {
                (n(({ response: a, preventDefault: w }) => {
                    let c = window.filamentErrorNotifications;
                    if (!c) return;
                    try {
                        let S = t?.payload;
                    ...
                    i(() => {
                        let a = window.filamentErrorNotifications;
                        if (!a) return;
                        let w = a[''];
                        new FilamentNotification()
                            .title(w.title)
    ...
    var x = window.history.replaceState,
        de = window.history.pushState;
    window.history.replaceState = function (t, n, i) {
        t?.url instanceof URL && (t.url = t.url.toString());
        let a = i || t?.url || window.location.href,
            w = window.location.href;
        if (a !== w) {
            x.call(window.history, t, n, i);
            return;
        }
        try {
    ...
    window.setUpSpaModeUnsavedDataChangesAlert = ({
        ...
        (document.addEventListener('livewire:navigate', (c) => {
            ...
            window.addEventListener('beforeunload', (c) => {
                a() && (c.preventDefault(), (c.returnValue = !0));
            }));
    };
    ...
    document.addEventListener('alpine:init', () => {
        (window.Alpine.plugin(j), window.Alpine.store('sidebar', F()));
    });
})();
