...
var Zo = (i, t, e) =>
    t in i
        ? Jo(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (i[t] = e);
var M = (i, t, e) => Zo(i, typeof t != 'symbol' ? t + '' : t, e);
function ve(i) {
    return (i + 0.5) | 0;
}
var wt = (i, t, e) => Math.max(Math.min(i, e), t);
function _e(i) {
...
var nt = {
    ...
    Ai = [...'0123456789ABCDEF'],
    Qo = (i) => Ai[i & 15],
    ta = (i) => Ai[(i & 240) >> 4] + Ai[i & 15],
    Ue = (i) => (i & 240) >> 4 === (i & 15),
    ea = (i) => Ue(i.r) && Ue(i.g) && Ue(i.b) && Ue(i.a);
function ia(i) {
    var t = i.length,
        e;
    return (
...
var Xe;
function pa(i) {
    Xe || ((Xe = ga()), (Xe.transparent = [0, 0, 0, 0]));
    let t = Xe[i.toLowerCase()];
...
function ba(i) {
    ...
    if (t) {
        if (t[7] !== s) {
            let a = +t[7];
            e = t[8] ? _e(a) : wt(a * 255, 0, 255);
        }
        return (
            (s = +t[1]),
            (n = +t[3]),
            (o = +t[5]),
            (s = 255 & (t[2] ? _e(s) : wt(s, 0, 255))),
            (n = 255 & (t[4] ? _e(n) : wt(n, 0, 255))),
            (o = 255 & (t[6] ? _e(o) : wt(o, 0, 255))),
            { r: s, g: n, b: o, a: e }
        );
    }
}
...
var Oi = (i) =>
    ...
    Gt = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
function _a(i, t, e) {
    let s = Gt(mt(i.r)),
        n = Gt(mt(i.g)),
        o = Gt(mt(i.b));
    return {
        r: St(Oi(s + e * (Gt(mt(t.r)) - s))),
        g: St(Oi(n + e * (Gt(mt(t.g)) - n))),
        b: St(Oi(o + e * (Gt(mt(t.b)) - o))),
        a: i.a + e * (t.a - i.a),
    };
}
function Ke(i, t, e) {
...
var ye = class i {
    ...
    greyscale() {
        let t = this._rgb,
            e = ve(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
...
function Ze(i) {
    if (z(i)) return i.map(Ze);
    if (T(i)) {
        let t = Object.create(null),
            e = Object.keys(i),
            s = e.length,
            n = 0;
        for (; n < s; ++n) t[e[n]] = Ze(i[e[n]]);
        return t;
    }
    return i;
}
...
function Ma(i, t, e) {
    ...
    T(s) && T(n)
        ? te(s, n)
        : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ze(n));
}
var $s = { '': (i) => i, x: (i) => i.x, y: (i) => i.y };
function ka(i) {
    let t = i.split('.'),
        e = [],
        s = '';
...
function Vi(i) {
    let t = Math.round(i);
    i = ie(i, t, i / 1e3) ? t : i;
    let e = Math.pow(10, Math.floor(xt(i))),
        s = i / e;
...
var hn = ['push', 'pop', 'shift', 'splice', 'unshift'];
function dn(i, t) {
    if (i._chartjs) {
...
var oi = (i) => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center'),
    K = (i, t, e) => (i === 'start' ? t : i === 'end' ? e : (t + e) / 2),
    fn = (i, t, e, s) =>
...
function Xi(i, t, e) {
    ...
    if (i._sorted) {
        let { iScale: a, vScale: r, _parsed: l } = i,
            c =
                i.dataset && i.dataset.options
                    ? i.dataset.options.spanGaps
                    : null,
            h = a.axis,
            {
                min: d,
        ...
        if (g) {
            ...
            if (c) {
                let m = l.slice(p - 1).findIndex((b) => !A(b[r.axis]));
                p += Math.max(0, m);
            }
            o = Y(p, n, s) - n;
        } else o = s - n;
...
var qe = (i) => i === 0 || i === 1,
    ...
    Xs = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * B) / e) + 1,
    Jt = {
        linear: (i) => i,
        easeInQuad: (i) => i * i,
        easeOutQuad: (i) => -i * (i - 2),
        ...
        easeInElastic: (i) => (qe(i) ? i : Us(i, 0.075, 0.3)),
        easeOutElastic: (i) => (qe(i) ? i : Xs(i, 0.075, 0.3)),
        easeInOutElastic(i) {
            return qe(i)
                ? i
                : i < 0.5
        ...
        easeInOutBounce: (i) =>
            i < 0.5
                ? Jt.easeInBounce(i * 2) * 0.5
                : Jt.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
    };
function qi(i) {
...
function Gi(i) {
    return qi(i) ? i : new ye(i);
}
function Ei(i) {
    return qi(i) ? i : new ye(i).saturate(0.5).darken(0.1).hexString();
}
var Oa = ['x', 'y', 'borderWidth', 'radius', 'tension'],
    Aa = ['color', 'borderColor', 'backgroundColor'];
function Ta(i) {
    (i.set('animation', {
        delay: void 0,
        duration: 1e3,
        ...
        i.set('animations', {
            ...
            numbers: { type: 'number', properties: Oa },
        }),
...
var gn = {
    ...
    logarithmic(i, t, e) {
        if (i === 0) return '0';
        let s = e[t].significand || i / Math.pow(10, Math.floor(xt(i)));
...
function Ii(i, t, e) {
    return typeof t == 'string' ? Zt(Me(i, t), e) : Zt(Me(i, ''), t);
}
var Fi = class {
        constructor(t, e) {
...
function pn(i, t, e, s) {
    ...
    let a = 0,
        ...
        u;
    for (l = 0; l < r; l++)
        if (((d = e[l]), d != null && !z(d))) a = ke(i, n, o, a, d);
        else if (z(d))
            for (c = 0, h = d.length; c < h; c++)
                ((u = d[c]), u != null && !z(u) && (a = ke(i, n, o, a, u)));
    i.restore();
    let f = o.length / 2;
    if (f > e.length) {
        ...
        switch ((i.beginPath(), f)) {
            ...
            case 'rectRounded':
                ((c = p * 0.516),
                    (l = p - c),
                    (a = Math.cos(m + Ft) * l),
                    (d = Math.cos(m + Ft) * (n ? n / 2 - c : l)),
                    (r = Math.sin(m + Ft) * l),
                    (u = Math.sin(m + Ft) * (n ? n / 2 - c : l)),
...
function li(i, t) {
    let e = {},
        s = T(t),
        n = s ? Object.keys(t) : t,
        o = T(i) ? (s ? (a) => D(i[a], i[t[a]]) : (a) => i[a]) : () => i;
    for (let a of n) e[a] = ja(o(a));
    return e;
}
function Qi(i) {
...
var Ka = (i, t) => (i === !0 ? t : typeof i == 'string' ? _t(t, i) : void 0);
function qa(i, t, e, s, n) {
    for (let o of t) {
        let a = Ka(e, o);
        if (a) {
            i.add(a);
            let r = yn(a._fallback, e, n);
...
function Gs(i) {
    let t = i._keys;
    return (t || (t = i._keys = Za(i._scopes)), t);
}
function Za(i) {
    let t = new Set();
    for (let e of i)
...
var Qa = Number.EPSILON || 1e-14,
    Qt = (i, t) => t < i.length && !i[t].skip && i[t],
    Mn = (i) => (i === 'x' ? 'y' : 'x');
function tr(i, t, e, s) {
    let n = i.skip ? t : i,
        o = t,
...
function ir(i, t, e = 'x') {
    let s = Mn(e),
        ...
        l = Qt(i, 0);
    for (let c = 0; c < n; ++c) {
        if (((a = r), (r = l), (l = Qt(i, c + 1)), !r)) continue;
        let h = r[e],
            d = r[s];
        (a &&
            ((o = (h - a[e]) / 3),
    ...
    for (e = 0, s = i.length; e < s; ++e)
        ((a = o),
            ...
            o &&
                ((n = i[e]),
                a &&
                    ((n.cp1x = Ge(n.cp1x, t.left, t.right)),
                    (n.cp1y = Ge(n.cp1y, t.top, t.bottom))),
                r &&
                    ((n.cp2x = Ge(n.cp2x, t.left, t.right)),
                    (n.cp2y = Ge(n.cp2y, t.top, t.bottom)))));
}
...
var ui = (i) => i.ownerDocument.defaultView.getComputedStyle(i, null);
function or(i, t) {
...
var rr = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function lr(i, t) {
    let e = i.touches,
        s = e && e.length ? e[0] : i,
...
function wn(i, t, e, s) {
    let n = ui(i),
        o = zt(n, 'margin'),
        a = ei(n.maxWidth, i, 'clientWidth') || Qe,
        r = ei(n.maxHeight, i, 'clientHeight') || Qe,
        l = cr(i, t, e),
        { width: c, height: h } = l;
    if (n.boxSizing === 'content-box') {
        let u = zt(n, 'border', 'width'),
            f = zt(n, 'padding');
    ...
    return (
        ...
        (c = Dt(Math.min(c, a, l.maxWidth))),
        (h = Dt(Math.min(h, r, l.maxHeight))),
        c && !h && (h = Dt(c / 2)),
        (t !== void 0 || e !== void 0) &&
            s &&
            l.height &&
            h > l.height &&
            ((h = l.height), (c = Dt(Math.floor(h * s)))),
        { width: c, height: h }
    );
}
function ns(i, t, e) {
...
function Cn(i) {
    return i === 'angle'
        ? { between: se, compare: Ca, normalize: X }
...
function ls(i, t, e) {
    ...
    let { property: s, start: n, end: o } = e,
        a = t.length,
        { compare: r, between: l, normalize: c } = Cn(s),
        { start: h, end: d, loop: u, style: f } = ur(i, t, e),
        g = [],
        p = !1,
        m = null,
        b,
    ...
    return (
        m !== null &&
            g.push(Js({ start: m, end: d, loop: u, count: a, style: f })),
        g
    );
}
function cs(i, t) {
...
function On(i, t) {
    ...
    if (!n) return [];
    let o = !!i._loop,
        { start: a, end: r } = fr(e, n, o, s);
    if (s === !0) return Zs(i, [{ start: a, end: r, loop: o }], e, t);
    let l = r < a ? r + n : r,
        c = !!i._fullLoop && a === 0 && r === n - 1;
    return Zs(i, gr(e, a, l, c), e, t);
}
function Zs(i, t, e, s) {
...
var fs = (i) => i === 'reset' || i === 'none',
    In = (i, t) => (t ? i : Object.assign({}, i)),
    Or = (i, t, e) =>
    ...
    it = class {
        ...
        updateIndex(t) {
            (this.index !== t && Ce(this._cachedMeta), (this.index = t));
        }
        linkScales() {
            let t = this.chart,
                e = this._cachedMeta,
                ...
                o = (e.xAxisID = D(s.xAxisID, us(t, 'x'))),
                a = (e.yAxisID = D(s.yAxisID, us(t, 'y'))),
                r = (e.rAxisID = D(s.rAxisID, us(t, 'r'))),
                l = e.indexAxis,
        ...
        _destroy() {
            let t = this._cachedMeta;
            (this._data && ji(this._data, this), t._stacked && Ce(t));
        }
        _dataCheck() {
        ...
        buildOrUpdateElements(t) {
            ...
            ((e._stacked = ds(e.vScale, e)),
                e.stack !== s.stack && ((n = !0), Ce(e), (e.stack = s.stack)),
        ...
        getContext(t, e, s) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                ((o = a.$context || (a.$context = Cr(this.getContext(), t, a))),
        ...
        _resolveElementOptions(t, e = 'default', s) {
            let n = e === 'active',
                ...
                a = t + '-' + e,
                r = o[a],
                l = this.enableOptionSharing && ee(s);
            if (r) return In(r, l);
            ...
            return (
                p.$shared &&
                    ((p.$shared = l), (o[a] = Object.freeze(In(p, l)))),
                p
            );
        }
...
function Tr(i) {
    let t = i.iScale,
        ...
        l = () => {
            a === 32767 ||
                a === -32768 ||
                (ee(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
        };
...
function zr(i, t, e, s) {
    ...
    let { start: a, end: r, reverse: l, top: c, bottom: h } = Fr(i);
    (n === 'middle' &&
        e &&
...
var le = class extends it {
    ...
    _getStacks(t, e) {
        let { iScale: s } = this._cachedMeta,
            ...
            l = r && r[s.axis],
            c = (h) => {
                let d = h._parsed.find((f) => f[s.axis] === l),
                    u = d && d[h.vScale.axis];
    ...
    _getAxis() {
        ...
        for (let s of this.chart.data.datasets)
            t[
                D(
    ...
    _calculateBarValuePixels(t) {
        ...
        if (b === e.getPixelForValue(r)) {
            let x = (lt(p) * e.getLineWidthForValue(r)) / 2;
            ((b += x), (p -= x));
        }
    ...
    _calculateBarIndexPixels(t, e) {
        let s = e.scale,
            n = this.options,
            o = n.skipNull,
            a = D(n.maxBarThickness, 1 / 0),
            r,
            l,
            c = this._getAxisCount();
        if (e.grouped) {
            let h = o ? this._getStackCount(t) : e.stackCount,
                d =
                    n.barThickness === 'flex'
                        ? Rr(t, e, n, h * c)
                        : Lr(t, e, n, h * c),
...
function Wr(i, t, e) {
    ...
    if (t < B) {
        let r = i,
            ...
            u = Math.sin(l),
            f = (v, y, _) =>
                se(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e),
            g = (v, y, _) =>
                se(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e),
            p = f(0, c, d),
            m = f(H, h, u),
            b = g(R, c, d),
            x = g(R + H, h, u);
...
var kt = class extends it {
    ...
    update(t) {
        let e = this.chart,
            ...
            l = Math.min(en(this.options.cutout, r), 1),
            c = this._getRingWeight(this.index),
            { circumference: h, rotation: d } = this._getRotationExtents(),
            { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = Wr(d, h, l),
            m = (s.width - a) / u,
            b = (s.height - a) / f,
            x = Math.max(Math.min(m, b) / 2, 0),
            v = zi(this.options.radius, x),
            y = Math.max(v * l, 0),
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = ne(e._parsed[t], s.options.locale);
...
var he = class extends it {
    ...
    updateElements(t, e, s, n) {
        let o = n === 'reset',
            ...
            m = Vt(g) ? g : Number.POSITIVE_INFINITY,
        ...
        for (let _ = 0; _ < v; ++_) {
            ...
            let S = this.getParsed(_),
                P = A(S[f]),
                C = (w[u] = a.getPixelForValue(S[u], _)),
                O = (w[f] =
                    o || P
                        ? r.getBasePixel()
                        : r.getPixelForValue(
...
var Yt = class extends it {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = ne(e._parsed[t].r, s.options.locale);
        return { label: n[t] || '', value: o };
    }
    parseObjectData(t, e, s, n) {
...
var ue = class extends it {
    ...
    updateElements(t, e, s, n) {
        let o = n === 'reset',
            ...
            b = Vt(p) ? p : Number.POSITIVE_INFINITY,
        ...
        for (let y = e; y < e + s; ++y) {
            let _ = t[y],
                ...
                w = x ? _ : {},
                S = A(k[g]),
                P = (w[f] = a.getPixelForValue(k[f], y)),
                C = (w[g] =
                    o || S
                        ? r.getBasePixel()
                        : r.getPixelForValue(
...
var Nr = Object.freeze({
    ...
    LineController: he,
    PieController: Re,
    PolarAreaController: Yt,
    RadarController: de,
    ScatterController: ue,
});
function Nt() {
    throw new Error(
    ...
    if (r && t === r.axis && t !== 'r' && a && o.length) {
        ...
        if (s) {
            ...
            if (l) {
                ...
                h.lo -= Math.max(0, f);
                let g = u.slice(h.hi).findIndex((p) => !A(p[d.axis]));
                h.hi += Math.max(0, g);
            }
            return h;
        }
...
function Yr(i, t, e, s) {
    ...
    function o(a, r, l) {
        let { startAngle: c, endAngle: h } = a.getProps(
            ...
            { angle: d } = Hi(a, { x: t.x, y: t.y });
        se(d, c, h) && n.push({ element: a, datasetIndex: r, index: l });
    }
    return ($e(i, e, t, o), n);
}
        ...
        modes: {
            index(i, t, e, s) {
                let n = Lt(t, i),
                    ...
                    r = e.intersect ? ps(i, n, o, s, a) : ms(i, n, o, !1, s, a),
                    l = [];
                return r.length
...
function Zr(i, t, e, s) {
    ...
    let r = Math.max(0, t.outerWidth - Nn(a, i, 'left', 'right')),
        l = Math.max(0, t.outerHeight - Nn(a, i, 'top', 'bottom')),
        c = r !== i.w,
        h = l !== i.h;
    return (
        (i.w = r),
...
function al(i, t, e) {
    let s = i.canvas,
        n = new MutationObserver((o) => {
            let a = !1;
            for (let r of o)
                ((a = a || ki(r.addedNodes, s)),
                    (a = a && !ki(r.removedNodes, s)));
            a && e();
        });
...
function ll(i, t) {
    (Ne.size || window.addEventListener('resize', Io), Ne.set(i, t));
}
function cl(i) {
    (Ne.delete(i), Ne.size || window.removeEventListener('resize', Io));
}
function hl(i, t, e) {
    let s = i.canvas,
        n = s && di(s);
...
var Ps = class extends Mi {
    ...
    addEventListener(t, e, s) {
        ...
        let n = t.$proxies || (t.$proxies = {}),
            a = { attach: al, detach: rl, resize: hl }[e] || dl;
        n[e] = a(t, e, s);
    }
...
function gi(i, t, e, s, n) {
    let o = D(s, 0),
        a = Math.min(D(n, i.length), i.length),
        r = 0,
        l,
        c,
        h;
...
var _l = (i) => (i === 'left' ? 'right' : i === 'right' ? 'left' : i),
    Yn = (i, t, e) => (t === 'top' || t === 'left' ? i[t] + e : i[t] - e),
    Un = (i, t) => Math.min(t || i, i);
function Xn(i, t) {
    let e = [],
        s = i.length / t,
        n = i.length,
...
var Xt = class i extends st {
        ...
        calculateLabelRotation() {
            let t = this.options,
                e = t.ticks,
                s = Un(this.ticks.length, t.ticks.maxTicksLimit),
                n = e.minRotation || 0,
                o = e.maxRotation,
                a = n,
                r,
        ...
        fit() {
            let t = { width: 0, height: 0 },
                ...
                r = this.isHorizontal();
            if (a) {
                let l = Kn(n, e.options.font);
                if (
                    (r
                        ? ((t.width = this.maxWidth), (t.height = Te(o) + l))
                        : ((t.height = this.maxHeight), (t.width = Te(o) + l)),
        ...
        _computeLabelSizes(t, e, s) {
            ...
            for (d = 0; d < e; d += l) {
                if (
                    ...
                    ((v = ke(n, b.data, b.gc, v, g)), (y = x));
                else if (z(g))
                    for (u = 0, f = g.length; u < f; ++u)
                        ((_ = g[u]),
                            !A(_) &&
                                !z(_) &&
                                ((v = ke(n, b.data, b.gc, v, _)), (y += x)));
                (a.push(v),
                    r.push(y),
                    (c = Math.max(v, c)),
                    (h = Math.max(y, h)));
        ...
        getContext(t) {
            ...
            return (
                this.$context ||
                (this.$context = Ml(this.chart.getContext(), this))
            );
        }
        _tickSize() {
            let t = this.options.ticks,
                e = ot(this.labelRotation),
        ...
        _computeGridLineItems(t) {
            ...
            if (a === 'top')
                ...
                ((k = x - m), (S = k - u), (C = t.left), (L = t.right));
            }
            let et = D(n.ticks.maxTicksLimit, d),
                I = Math.max(1, Math.ceil(d / et));
            for (v = 0; v < d; v += I) {
                let W = this.getContext(v),
                    j = o.setContext(W),
                    rt = r.setContext(W),
                    G = j.lineWidth,
                    Kt = j.color,
        ...
        _computeLabelItems(t) {
            ...
            if (n === 'top')
                ...
                let I = this._getYAxisLabelAlignment(u);
                ((w = I.textAlign), (_ = I.x));
            } else if (n === 'right') {
                let I = this._getYAxisLabelAlignment(u);
                ((w = I.textAlign), (_ = I.x));
            ...
            for (b = 0, x = r.length; b < x; ++b) {
                ...
                a
                    ? ((_ = S),
                      w === 'inner' &&
                          (b === x - 1
                              ? (Kt = this.options.reverse ? 'left' : 'right')
                              : b === 0
                                ? (Kt = this.options.reverse ? 'right' : 'left')
                                : (Kt = 'center')),
                      n === 'top'
                          ? c === 'near' || p !== 0
                              ? (L = -O * C + C / 2)
                              : c === 'center'
                                ? (L = -et.highest.height / 2 - W * C + C)
                                : (L = -et.highest.height + C / 2)
                          : c === 'near' || p !== 0
                            ? (L = C / 2)
                            : c === 'center'
                              ? (L = et.highest.height / 2 - W * C)
                              : (L = et.highest.height - O * C),
                      d && (L *= -1),
                      p !== 0 &&
                          !I.showLabelBackdrop &&
                          (_ += (C / 2) * Math.sin(p)))
    ...
    pe = class {
        ...
        unregister(t) {
            ...
            (s in e && delete e[s],
                n &&
                    s in V[n] &&
                    (delete V[n][s], this.override && delete Ct[s]));
        }
    };
function Pl(i, t, e) {
    let s = Zt(Object.create(null), [e ? V.get(e) : {}, V.get(t), i.defaults]);
    (V.set(t, s),
...
var Ds = class {
        constructor() {
            ((this.controllers = new pe(it, 'datasets', !0)),
                (this.elements = new pe(st, 'elements')),
                (this.plugins = new pe(Object, 'plugins')),
                (this.scales = new pe(Xt, 'scales')),
    ...
    Cs = class {
        ...
        _notifyStateChanges(t) {
            let e = this._oldCache || [],
                ...
                n = (o, a) =>
                    o.filter(
                        (r) => !a.some((l) => r.plugin.id === l.plugin.id),
                    );
...
function Ol(i) {
    let t = {},
        e = [],
        s = Object.keys(gt.plugins.items);
...
function zl(i, t) {
    ...
    return (
        Object.keys(s).forEach((a) => {
            ...
            let l = As(a, r, Fl(a, i), V.scales[r.type]),
                c = El(l, n),
                h = e.scales || {};
            o[a] = te(Object.create(null), [{ axis: l }, r, h[l], h[c]]);
        }),
        i.data.datasets.forEach((a) => {
            let r = a.type || i.type,
                l = a.indexAxis || Os(r, t),
                h = (Ct[r] || {}).scales || {};
            Object.keys(h).forEach((d) => {
                let u = Rl(d, l),
                    f = a[u + 'AxisID'] || u;
                ((o[f] = o[f] || Object.create(null)),
                    te(o[f], [{ axis: u }, s[f], h[d]]));
            });
        }),
        Object.keys(o).forEach((a) => {
            let r = o[a];
            te(r, [V.scales[r.type], V.scale]);
        }),
        o
    );
}
...
function pi(i, t) {
    let e = Jn.get(i);
    return (e || ((e = t()), Jn.set(i, e), Bo.add(e)), e);
}
var Le = (i, t, e) => {
        let s = _t(t, e);
        s !== void 0 && i.add(s);
    ...
    Ts = class {
        ...
        getOptionScopes(t, e, s) {
            ...
            let l = new Set();
            e.forEach((h) => {
                (t && (l.add(t), h.forEach((d) => Le(l, t, d))),
                    h.forEach((d) => Le(l, n, d)),
                    h.forEach((d) => Le(l, Ct[o] || {}, d)),
                    h.forEach((d) => Le(l, V, d)),
                    h.forEach((d) => Le(l, ai, d)));
            });
            let c = Array.from(l);
            return (
        ...
        chartOptionScopes() {
            ...
            return [t, Ct[e] || {}, V.datasets[e] || {}, { type: e }, V, ai];
        }
        resolveNamedOptions(t, e, s, n = ['']) {
            let o = { $shared: !0 },
                { resolver: a, subPrefixes: r } = Zn(this._resolverCache, t, n),
                l = a;
            if (Wl(a, e)) {
        ...
        createResolver(t, e, s = [''], n) {
            let { resolver: o } = Zn(this._resolverCache, t, s);
            return T(e) ? Bt(o, e, void 0, n) : o;
        }
    };
function Zn(i, t, e) {
    let s = i.get(t);
...
var Vl = (i) => T(i) && Object.getOwnPropertyNames(i).some((t) => bt(i[t]));
function Wl(i, t) {
    let { isScriptable: e, isIndexable: s } = ts(i);
    for (let n of t) {
        let o = e(n),
            a = s(n),
            r = (a || o) && i[n];
...
var Nl = '4.5.1',
    Hl = ['top', 'bottom', 'left', 'right', 'chartArea'];
function Qn(i, t) {
    ...
    buildOrUpdateControllers() {
        ...
        for (
            ...
            if (
                ...
                (a.type = r),
                (a.indexAxis = o.indexAxis || Os(r, this.options)),
                (a.order = o.order || 0),
                (a.index = s),
                (a.label = '' + o.label),
...
function Ul(i, t, e) {
    let {
        ...
        d = Math.min(c / a, X(s - e));
    if ((i.beginPath(), i.arc(n, o, a - c / 2, s + d / 2, e - d / 2), r > 0)) {
        let u = Math.min(c / r, X(s - e));
        i.arc(n, o, r + c / 2, e - u / 2, s + u / 2, !0);
    } else {
        let u = Math.min(c / 2, a * X(s - e));
        if (h === 'round') i.arc(n, o, u, e - R / 2, s + R / 2, !0);
        else if (h === 'bevel') {
            let f = 2 * u * u,
                g = -f * Math.cos(e + R / 2) + n,
                p = -f * Math.sin(e + R / 2) + o,
                m = f * Math.cos(s + R / 2) + n,
                b = f * Math.sin(s + R / 2) + o;
...
function ql(i, t, e, s) {
    let n = Kl(i.options.borderRadius),
        o = (e - t) / 2,
        a = Math.min(o, (s * t) / 2),
        r = (l) => {
...
function wi(i, t, e, s, n, o) {
    ...
    let p = Math.max(0.001, g * d - e / R) / d,
        m = (g - p) / 2,
        b = l + m + f,
        x = n - m - f,
        {
    ...
    if ((i.beginPath(), o)) {
        let I = (P + C) / 2;
        if ((i.arc(a, r, d, P, I), i.arc(a, r, d, I, C), y > 0)) {
            let G = re(S, C, a, r);
            i.arc(G.x, G.y, y, C, x + H);
        }
        let W = re(L, x, a, r);
        ...
        i.moveTo(a, r);
        let I = Math.cos(P) * d + a,
            W = Math.sin(P) * d + r;
        i.lineTo(I, W);
        let j = Math.cos(C) * d + a,
            rt = Math.sin(C) * d + r;
        i.lineTo(j, rt);
    }
    i.closePath();
...
function Jl(i, t, e, s, n) {
    let { fullCircles: o, startAngle: a, circumference: r, options: l } = t,
        {
            borderWidth: c,
            borderJoinStyle: h,
            borderDash: d,
...
var jt = class extends st {
    ...
    inRange(e, s, n) {
        let o = this.getProps(['x', 'y'], n),
            { angle: a, distance: r } = Hi(o, { x: e, y: s }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
    ...
    draw(e) {
        let { options: s, circumference: n } = this,
            o = (s.offset || 0) / 4,
            a = (s.spacing || 0) / 2,
            r = s.circular;
        if (
        ...
        let c = 1 - Math.sin(Math.min(R, n || 0)),
            h = o * c;
...
(M(jt, 'id', 'arc'),
    ...
    M(jt, 'defaultRoutes', { backgroundColor: 'backgroundColor' }),
    M(jt, 'descriptors', {
        _scriptable: !0,
...
function tc(i, t, e, s) {
    let { points: n, options: o } = t,
        { count: a, start: r, loop: l, ilen: c } = No(n, e, s),
        h = Ql(o),
    ...
    for (f = 0; f <= c; ++f)
        ((g = n[(r + (u ? c - f : f)) % a]),
            !g.skip &&
                ...
                (p = g)));
    return (
        l && ((g = n[(r + (u ? c : 0)) % a]), h(i, p, g, u, o.stepped)), !!l
    );
}
function ec(i, t, e, s) {
    let n = t.points,
        { count: o, start: a, ilen: r } = No(n, e, s),
...
var pt = class extends st {
    ...
    get segments() {
        return (
            this._segments || (this._segments = On(this, this.options.segment))
        );
    }
    first() {
        let t = this.segments,
    ...
    interpolate(t, e) {
        let s = this.options,
            n = t[e],
            o = this.points,
            a = cs(this, { property: e, start: n, end: n });
        if (!a.length) return;
        let r = [],
            l = ic(s),
            c,
...
var uc = Object.freeze({
    ...
    oo = Rs.map((i) => i.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function jo(i) {
...
function wc(i, t, e) {
    ...
    for (let r of s) {
        ...
        let d = cs(t, h);
        for (let u of d) {
            let f = Es(e, o[u.start], o[u.end], u.loop),
                g = ls(r, n, f);
            for (let p of g)
                a.push({
                    source: p,
...
function vs(i, t) {
    ...
    for (let { source: c, target: h, start: d, end: u } of l) {
        ...
        (i.save(),
            ...
            Hc(i, a, r, g && Es(n, d, u)),
            i.beginPath());
        let p = !!e.pathSegment(i, c),
            m;
        if (g) {
            p ? i.closePath() : fo(i, s, u, n);
            let b = !!s.pathSegment(i, h, { move: p, reverse: !0 });
            ((m = p && b), m || fo(i, s, d, n));
        }
    ...
    Pi = class extends st {
        ...
        buildLabels() {
            let t = this.options.labels || {},
                e = F(t.generateLabels, [this.chart], this) || [];
        ...
        fit() {
            ...
            let s = t.labels,
                ...
                { boxWidth: r, itemHeight: l } = go(s, o),
                c,
                h;
            ((e.font = n.string),
                this.isHorizontal()
        ...
        _fitCols(t, e, s, n) {
            ...
            return (
                this.legendItems.forEach((m, b) => {
                    let { itemWidth: x, itemHeight: v } = Yc(s, e, o, m, n);
                    (b > 0 &&
                        f + v + 2 * r > h &&
                        ((d += u + r),
        ...
        _draw() {
            ...
            (this.drawTitle(),
                ...
                (n.lineWidth = 0.5),
                (n.font = c.string));
            let { boxWidth: g, boxHeight: p, itemHeight: m } = go(a, d),
                b = function (k, w, S) {
                    if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return;
                    n.save();
                    let P = D(S.lineWidth, 1);
                    if (
                        ...
                        let C = {
                            ...
                            O = l.xPlus(k, g / 2),
                            L = w + u;
                        Zi(n, C, O, L, a.pointStyleWidth && g);
                    } else {
                        let C = w + Math.max((d - p) / 2, 0),
                            O = l.leftForLtr(k, g),
                            L = Tt(S.borderRadius);
                        (n.beginPath(),
                            Object.values(L).some((U) => U !== 0)
                                ? oe(n, { x: O, y: C, w: g, h: p, radius: L })
                                : n.rect(O, C, g, p),
                            n.fill(),
                            P !== 0 && n.stroke());
                    }
            ...
            (this.legendItems.forEach((k, w) => {
                ...
                let S = n.measureText(k.text).width,
                    P = l.textAlign(k.textAlign || (k.textAlign = a.textAlign)),
                    C = g + u + S,
                    O = f.x,
                    L = f.y;
                (l.setWidth(this.width),
                    v
                        ? w > 0 &&
                          ...
                          f.line++,
                          (O = f.x =
                              K(o, this.left + h, this.right - s[f.line])))
                        : w > 0 &&
                          L + _ > this.bottom &&
                ...
                if (
                    (b(U, L, k),
                    (O = fn(P, O + g + u, v ? O + C : this.right, t.rtl)),
                    x(l.x(O), L, k),
                    v)
                )
                    f.x += C + h;
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = q(e.padding);
            if (!e.display) return;
            let o = Wt(t.rtl, this.left, this.width),
                a = this.ctx,
                r = e.position,
                l = s.size / 2,
                c = n.top + l,
...
var qc = {
        ...
        _element: Pi,
        start(i, t, e) {
            let s = (i.legend = new Pi({ ctx: i.ctx, options: e, chart: i }));
    ...
    He = class extends st {
        ...
        update(t, e) {
            ...
            let n = z(s.text) ? s.text.length : 1;
...
function Gc(i, t) {
    let e = new He({ ctx: i.ctx, options: t, chart: i });
...
var Jc = {
    ...
    Zc = {
        id: 'subtitle',
        start(i, t, e) {
            let s = new He({ ctx: i.ctx, options: e, chart: i });
            (J.configure(i, s, e), J.addBox(i, s), mi.set(i, s));
        },
        stop(i) {
            (J.removeBox(i, mi.get(i)), mi.delete(i));
        },
        beforeUpdate(i, t, e) {
            let s = mi.get(i);
            (J.configure(i, s, e), (s.options = e));
...
function mo(i, t, e) {
    let s = e.yAlign || t.yAlign || th(i, e);
...
function bo(i, t, e, s) {
    let { caretSize: n, caretPadding: o, cornerRadius: a } = i,
        { xAlign: r, yAlign: l } = e,
        c = n + o,
        { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Tt(a),
        g = sh(t, r),
        p = nh(t, l, c);
    return (
        l === 'center'
...
var We = class extends st {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            let r = Ie[s.position].call(this, n, this._eventPosition);
            ...
            let l = (this._size = po(this, s)),
                c = Object.assign({}, r, l),
                h = mo(this.chart, s, c),
                d = bo(s, c, h, this.chart);
    ...
    getCaretPosition(t, e, s) {
        let { xAlign: n, yAlign: o } = this,
            ...
            { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Tt(r),
            { x: u, y: f } = t,
            { width: g, height: p } = e,
            m,
            b,
    ...
    drawTitle(t, e, s) {
        let n = this.title,
            ...
            l;
        if (o) {
            let c = Wt(s.rtl, this.x, this.width);
            for (
    ...
    _drawColorBox(t, e, s, n, o) {
        ...
        if (o.usePointStyle) {
            ...
            Object.values(b).some((x) => x !== 0)
                ? (t.beginPath(),
                  (t.fillStyle = o.multiKeyBackground),
                  oe(t, { x: p, y: g, w: c, h: l, radius: b }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = a.backgroundColor),
                  t.beginPath(),
                  oe(t, { x: m, y: g + 1, w: c - 2, h: l - 2, radius: b }),
                  t.fill())
                : ((t.fillStyle = o.multiKeyBackground),
                  t.fillRect(p, g, c, l),
    ...
    drawFooter(t, e, s) {
        let n = this.footer,
            ...
            r;
        if (o) {
            let l = Wt(s.rtl, this.x, this.width);
            for (
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = s && s.y;
        if (n || o) {
            let a = Ie[t.position].call(
                this,
                this._active,
                this._eventPosition,
            );
            if (!a) return;
            let r = (this._size = po(this, t)),
...
var ah = {
        ...
        positioners: Ie,
        afterInit(i, t, e) {
            e && (i.tooltip = new We({ chart: i, options: e }));
        },
        beforeUpdate(i, t, e) {
...
var hh = (i, t) => (i === null ? null : Y(Math.round(i), 0, t));
function yo(i) {
    let t = this.getLabels();
    return i >= 0 && i < t.length ? t[i] : i;
}
var Fe = class extends Xt {
    constructor(t) {
        (super(t),
...
(M(Fe, 'id', 'category'), M(Fe, 'defaults', { ticks: { callback: yo } }));
function dh(i, t) {
    let e = [],
        {
            bounds: n,
        ...
        b && x && o && an((r - a) / o, _ / 1e3)
            ...
            : v
              ? ((w = b ? a : w),
                ...
                (_ = (S - w) / P))
              : ((P = (S - w) / _),
                ie(P, Math.round(P), _ / 1e3)
                    ? (P = Math.round(P))
                    : (P = Math.ceil(P))));
    let C = Math.max(Ni(_), Ni(w));
    ((k = Math.pow(10, A(l) ? C : l)),
        (w = Math.round(w * k) / k),
        (S = Math.round(S * k) / k));
    let O = 0;
    for (
        ...
        (u && w !== a
            ? (e.push({ value: a }),
              w < a && O++,
              ie(Math.round((w + O * _) * k) / k, a, vo(a, y, i)) && O++)
            : w < a && O++);
        O < P;
        ++O
    ) {
        let L = Math.round((w + O * _) * k) / k;
        if (x && L > r) break;
        e.push({ value: L });
    }
    return (
        x && u && S !== r
            ? e.length && ie(e[e.length - 1].value, r, vo(r, y, i))
    ...
    ze = class extends me {
        ...
        computeTickLimit() {
            let t = this.isHorizontal(),
                ...
                s = ot(this.options.ticks.minRotation),
...
(M(ze, 'id', 'linear'),
    M(ze, 'defaults', { ticks: { callback: Se.formatters.numeric } }));
var je = (i) => Math.floor(xt(i)),
    Ht = (i, t) => Math.pow(10, je(i) + t);
function Mo(i) {
    return i / Math.pow(10, je(i)) === 1;
}
function ko(i, t, e) {
    let s = Math.pow(10, e),
        n = Math.floor(i / s);
...
var Be = class extends Xt {
    ...
    parse(t, e) {
        let s = me.prototype.parse.apply(this, [t, e]);
        if (s === 0) {
            this._zero = !0;
            return;
        }
    ...
    determineDataLimits() {
        ...
        ((this.min = N(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
                ...
                !N(this._userMin) &&
                (this.min =
                    t === Ht(this.min, 0) ? Ht(this.min, -1) : Ht(this.min, 0)),
            this.handleTickRangeOptions());
    }
    handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            o = (r) => (s = t ? s : r),
            a = (r) => (n = e ? n : r);
        (s === n && (s <= 0 ? (o(1), a(10)) : (o(Ht(s, -1)), a(Ht(n, 1)))),
            s <= 0 && o(Ht(n, -1)),
            n <= 0 && a(Ht(s, 1)),
            (this.min = s),
            (this.max = n));
...
(M(Be, 'id', 'logarithmic'),
    M(Be, 'defaults', {
        ticks: { callback: Se.formatters.logarithmic, major: { enabled: !0 } },
    }));
function Is(i) {
    let t = i.ticks;
    if (t.display && i.display) {
        let e = q(t.backdropPadding);
...
function ph(i) {
    let t = {
        ...
        r = a.centerPointLabels ? R / o : 0;
    for (let l = 0; l < o; l++) {
        let c = a.setContext(i.getPointLabelContext(l));
        n[l] = c.padding;
        let h = i.getPointPosition(l, i.drawingArea + n[l], r),
            d = $(c.font),
            u = gh(i.ctx, d, i._pointLabels[l]);
        s[l] = u;
        let f = X(i.getIndexAngle(l) + r),
            g = Math.round(si(f)),
            p = wo(g, h.x, u.w, 0, 180),
            m = wo(g, h.y, u.h, 90, 270);
        mh(e, t, f, p, m);
    }
...
function _h(i, t, e) {
    let s = [],
        ...
        l = { extra: Is(o) / 2, additionalAngle: a ? R / n : 0 },
        c;
    for (let h = 0; h < n; h++) {
...
function wh(i, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        At(e, i._pointLabels[n], l, c + r.lineHeight / 2, r, {
            color: a.color,
            textAlign: h,
            textBaseline: 'middle',
        });
...
var $t = class extends me {
    ...
    setDimensions() {
        let t = (this._padding = q(Is(this.options) / 2)),
    ...
    generateTickLabels(t) {
        (me.prototype.generateTickLabels.call(this, t),
            (this._pointLabels = this.getLabels()
                .map((e, s) => {
                    let n = F(this.options.pointLabels.callback, [e, s], this);
                    return n || n === 0 ? n : '';
                })
    ...
    getPointPosition(t, e, s = 0) {
        let n = this.getIndexAngle(t) - H + s;
        return {
...
(M($t, 'id', 'radialLinear'),
    ...
    M($t, 'descriptors', { angleLines: { _fallback: 'grid' } }));
var Ci = {
...
function Ch(i) {
    for (let t = tt.indexOf(i) + 1, e = tt.length; t < e; ++t)
        if (Ci[tt[t]].common) return tt[t];
}
function Co(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
        let { lo: s, hi: n } = ni(e, t),
            o = e[s] >= t ? e[s] : e[n];
        i[o] = !0;
    }
}
...
var Ut = class extends Xt {
    ...
    init(t, e = {}) {
        let s = t.time || (t.time = {}),
            n = (this._adapter = new Hr._date(t.adapters.date));
        (n.init(e),
            te(s.displayFormats, n.formats()),
            (this._parseOpts = {
                parser: s.parser,
                round: s.round,
    ...
    _generate() {
        let t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            a = o.unit || Do(o.minUnit, e, s, this._getLabelCapacity(e)),
            r = D(n.ticks.stepSize, 1),
        ...
        for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) Co(h, u, g);
        return (
            (u === s || n.bounds === 'ticks' || f === 1) && Co(h, u, g),
            Object.keys(h)
                .sort(So)
                .map((p) => +p)
        );
    ...
    _getLabelSize(t) {
        let e = this.options.ticks,
            ...
            n = ot(this.isHorizontal() ? e.maxRotation : e.minRotation),
            o = Math.cos(n),
            a = Math.sin(n),
...
(M(Ve, 'id', 'timeseries'), M(Ve, 'defaults', Ut.defaults));
