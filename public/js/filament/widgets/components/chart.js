...
var Jt = (s, t, e) => Math.max(Math.min(s, e), t);
function gs(s) {
    return Jt(ps(s * 2.55), 0, 255);
}
function Kt(s) {
    return Jt(ps(s * 255), 0, 255);
}
function Wt(s) {
...
function sh(s) {
    ...
    if (t) {
        if (t[7] !== i) {
            let o = +t[7];
            e = t[8] ? gs(o) : Jt(o * 255, 0, 255);
        }
        return (
            (i = +t[1]),
            (n = +t[3]),
            (r = +t[5]),
            (i = 255 & (t[2] ? gs(i) : Jt(i, 0, 255))),
            (n = 255 & (t[4] ? gs(n) : Jt(n, 0, 255))),
            (r = 255 & (t[6] ? gs(r) : Jt(r, 0, 255))),
            { r: i, g: n, b: r, a: e }
        );
    }
}
...
var ms = class s {
    ...
    greyscale() {
        let t = this._rgb,
            e = ps(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
...
function bi(s, t) {
    let e = t.x - s.x,
        ...
        n = Math.sqrt(e * e + i * i),
        r = Math.atan2(i, e);
    return (r < -0.5 * F && (r += H), { angle: r, distance: n });
}
function _s(s, t) {
...
function Ln(s) {
    return K(s, -32768, 32767);
}
function Dt(s, t, e, i = 1e-6) {
...
var Mt = (s, t, e, i) =>
        vs(
            ...
            i
                ? (n) => {
                      let r = s[n][t];
                      return r < e || (r === e && s[n + 1][t] === e);
                  }
                : (n) => s[n][t] < e,
        ),
    Fn = (s, t, e) => vs(s, e, (i) => s[i][t] >= e);
function Rn(s, t, e) {
    let i = 0,
        n = s.length;
    for (; i < n && s[i] < t; ) i++;
...
var Ss = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    et = (s, t, e) => (s === 'start' ? t : s === 'end' ? e : (t + e) / 2),
    Vn = (s, t, e, i) =>
...
function ki(s, t, e) {
    let i = t.length,
        ...
        r = i;
    if (s._sorted) {
        let { iScale: o, vScale: a, _parsed: l } = s,
            c =
                s.dataset && s.dataset.options
                    ? s.dataset.options.spanGaps
                    : null,
            h = o.axis,
            {
                min: u,
        ...
        if (f) {
            if (
                ((n = Math.min(
                    Mt(l, h, u).lo,
                    e ? i : Mt(t, h, o.getPixelForValue(u)).lo,
                )),
                c)
            ) {
                let m = l
...
var ai = (s) => s === 0 || s === 1,
    ...
    fe = {
        ...
        easeInBounce: (s) => 1 - fe.easeOutBounce(1 - s),
        easeOutBounce(s) {
            return s < 1 / 2.75
                ? 7.5625 * s * s
                : s < 2 / 2.75
        ...
        easeInOutBounce: (s) =>
            s < 0.5
                ? fe.easeInBounce(s * 2) * 0.5
                : fe.easeOutBounce(s * 2 - 1) * 0.5 + 0.5,
    };
function Si(s) {
...
var Po = {
    ...
    numeric(s, t, e) {
        ...
        return (Object.assign(l, this.options.ticks.format), _e(s, i, l));
    },
    logarithmic(s, t, e) {
        if (s === 0) return '0';
...
function Tn(s, t, e) {
    return typeof t == 'string' ? me(bs(s, t), e) : me(bs(s, ''), t);
}
var Dn = class {
        constructor(t, e) {
            ((this.animation = void 0),
                ...
                (this.hover = {}),
                (this.hoverBackgroundColor = (i, n) => hi(n.backgroundColor)),
                (this.hoverBorderColor = (i, n) => hi(n.borderColor)),
                (this.hoverColor = (i, n) => hi(n.color)),
                (this.indexAxis = 'x'),
                (this.interaction = {
                    mode: 'nearest',
                    intersect: !0,
...
function Oi(s, t, e, i, n) {
    ...
    if (!(isNaN(m) || m <= 0)) {
        switch ((s.beginPath(), f)) {
            default:
                (n ? s.ellipse(e, i, n / 2, m, 0, 0, H) : s.arc(e, i, m, 0, H),
                    s.closePath());
                break;
            case 'triangle':
                ((h = n ? n / 2 : m),
            ...
            case 'rectRounded':
                ((c = m * 0.516),
                    (l = m - c),
                    (o = Math.cos(p + Qt) * l),
                    (u = Math.cos(p + Qt) * (n ? n / 2 - c : l)),
                    (a = Math.sin(p + Qt) * l),
                    (d = Math.sin(p + Qt) * (n ? n / 2 - c : l)),
                    s.arc(e - u, i - a, c, p - F, p - q),
                    s.arc(e + d, i - o, c, p - q, p),
                    s.arc(e + u, i + a, c, p, p + q),
                    s.arc(e - d, i + o, c, p + q, p + F),
                    s.closePath());
                break;
            case 'rect':
                if (!g) {
...
function we(s, t) {
    ...
    (s.arc(e + o.topLeft, i + o.topLeft, o.topLeft, 1.5 * F, F, !0),
        s.lineTo(e, i + r - o.bottomLeft),
        s.arc(e + o.bottomLeft, i + r - o.bottomLeft, o.bottomLeft, F, q, !0),
...
function Di(s) {
    return Os(s, { top: 'y', right: 'x', bottom: 'y', left: 'x' });
}
function jt(s) {
    return Os(s, ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']);
}
function st(s) {
    let t = Di(s);
...
function X(s, t) {
    ...
    let n = {
        ...
        lineHeight: Io(P(s.lineHeight, t.lineHeight), e),
        size: e,
        style: i,
...
function ee(s, t, e, i) {
    let n = {
        ...
        _stack: new Set(),
        _descriptors: Ci(s, i),
        setContext: (r) => ee(s, r, e, i),
        override: (r) => ee(s.override(r), t, e, i),
    };
    return new Proxy(n, {
        deleteProperty(r, o) {
...
function Ci(s, t = { scriptable: !0, indexable: !0 }) {
    let {
    ...
    for (e = 0, i = s.length; e < i; ++e)
        ((o = r),
            ...
            r &&
                ((n = s[e]),
                o &&
                    ((n.cp1x = li(n.cp1x, t.left, t.right)),
                    (n.cp1y = li(n.cp1y, t.top, t.bottom))),
                a &&
                    ((n.cp2x = li(n.cp2x, t.left, t.right)),
                    (n.cp2y = li(n.cp2y, t.top, t.bottom)))));
}
    ...
    if (t === void 0 || e === void 0) {
        ...
        if (!r) ((t = s.clientWidth), (e = s.clientHeight));
            ...
            ((t = o.width - c.width - l.width),
                ...
                (i = ui(a.maxWidth, r, 'clientWidth')),
                (n = ui(a.maxHeight, r, 'clientHeight')));
        }
    }
    return { width: t, height: e, maxWidth: i || xs, maxHeight: n || xs };
}
var te = (s) => Math.round(s * 10) / 10;
function Zn(s, t, e, i) {
    let n = Ai(s),
        r = ge(n, 'margin'),
    ...
    return (
        ...
        (h = Math.max(0, i ? c / i : h - r.height)),
        (c = te(Math.min(c, o, l.maxWidth))),
        (h = te(Math.min(h, a, l.maxHeight))),
        c && !h && (h = te(c / 2)),
        (t !== void 0 || e !== void 0) &&
            i &&
            l.height &&
            h > l.height &&
            ((h = l.height), (c = te(Math.floor(h * i)))),
        { width: c, height: h }
    );
}
function Ii(s, t, e) {
    let i = t || 1,
        n = te(s.height * i),
        r = te(s.width * i);
    ((s.height = te(s.height)), (s.width = te(s.width)));
    let o = s.canvas;
    return (
        o.style &&
...
function Ri(s, t, e) {
    ...
    let { property: i, start: n, end: r } = e,
        ...
        k = () => m || w(),
        v = () => !m || x();
    for (let M = h, O = h; M <= u; ++M)
        ((y = t[M % o]),
            !y.skip &&
                ((b = c(y[i])),
                b !== _ &&
                    ((m = l(b, n, r)),
                    p === null && k() && (p = a(b, n) === 0 ? M : O),
                    p !== null &&
                        v() &&
                        (g.push(
                            xo({
...
function jh(s, t) {
    ...
    let e = [],
        i = function (n, r) {
            return Si(r) ? (e.includes(r) || e.push(r), e.indexOf(r)) : r;
        };
        ...
        update(t, e, i) {
            if (this._active) {
                ...
                ((this._start = i),
                    ...
                    (this._total += r),
                    (this._loop = !!t.loop),
                    (this._to = ke([t.to, e, n, t.from])),
                    (this._from = ke([t.from, n, e])));
            }
        }
        cancel() {
            this._active &&
    ...
    dt = class {
        ...
        linkScales() {
            let t = this.chart,
                ...
                r = (e.xAxisID = P(i.xAxisID, Qn(t, 'x'))),
                o = (e.yAxisID = P(i.yAxisID, Qn(t, 'y'))),
                a = (e.rAxisID = P(i.rAxisID, Qn(t, 'r'))),
                l = e.indexAxis,
        ...
        _destroy() {
            let t = this._cachedMeta;
            (this._data && yi(this._data, this), t._stacked && As(t));
        }
        _dataCheck() {
            ...
            if (E(e)) {
                ...
                (e && Object.isExtensible(e) && Nn(e, this),
                    (this._syncList = []),
                    (this._data = e));
            }
        }
        ...
        getMinMax(t, e) {
            ...
            function g() {
                f = n[d];
                let m = f[a.axis];
                return !Y(f[t.axis]) || h > m || u < m;
            }
            for (
                d = 0;
                d < o && !(!g() && (this.updateRangeFromParsed(c, t, f, l), r));
                ++d
            );
            if (r) {
                for (d = o - 1; d >= 0; --d)
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            let c = this.chart.config,
                ...
                f = Object.keys(j.elements[t]),
                g = () => this.getContext(i, n, e),
        ...
        updateSharedOptions(t, e, i) {
            t && !tr(e) && this._resolveAnimations(void 0, e).update(t, i);
        }
        _setStyle(t, e, i, n) {
            t.active = n;
...
function nu(s, t) {
    if (!s._cache.$bar) {
        ...
        s._cache.$bar = xi(i.sort((n, r) => n - r));
    }
    return s._cache.$bar;
}
function ru(s) {
    let t = s.iScale,
        ...
        l = () => {
            o === 32767 ||
                o === -32768 ||
                (be(a) && (i = Math.min(i, Math.abs(o - a) || i)), (a = o));
        };
...
var Ue = class extends dt {
        ...
        for (let f = e; f < e + i; f++) {
            let g = this.getParsed(f),
                ...
                y = {
                    ...
                    base: m.base,
                    enableBorderRadius:
                        !b || er(g._custom) || o === b._top || o === b._bottom,
                    x: c ? m.head : p.center,
                    y: c ? p.center : m.head,
    ...
    _calculateBarValuePixels(t) {
        ...
        if (b === e.getPixelForValue(a)) {
            let y = (yt(m) * e.getLineWidthForValue(a)) / 2;
            ((b += y), (m -= y));
        }
        ...
        for (let d = e; d < e + i; d++) {
            let f = t[d],
                ...
                p = (m[h] = r
                    ...
                    : o.getPixelForValue(g[h])),
                b = (m[u] = r ? a.getBasePixel() : a.getPixelForValue(g[u]));
...
function gu(s, t, e) {
    ...
    if (t < H) {
        let a = s,
            ...
            d = Math.sin(l),
            f = (_, w, x) =>
                xe(_, a, l, !0) ? 1 : Math.max(w, w * e, x, x * e),
            g = (_, w, x) =>
                xe(_, a, l, !0) ? -1 : Math.min(w, w * e, x, x * e),
            m = f(0, c, u),
            p = f(q, h, d),
            b = g(F, c, u),
            y = g(F + q, h, d);
...
var qt = class extends dt {
    ...
    updateElements(t, e, i, n) {
        let r = n === 'reset',
            ...
            { sharedOptions: m, includeOptions: p } = this._getSharedOptions(
                e,
                n,
            ),
            b = this._getRotation(),
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            r = _e(e._parsed[t], i.options.locale);
...
var Ze = class extends dt {
    ...
    updateElements(t, e, i, n) {
        let r = n === 'reset',
            ...
            p = se(g) ? g : Number.POSITIVE_INFINITY,
        ...
        for (let x = 0; x < _; ++x) {
            ...
            ((v.skip = isNaN(D) || isNaN(A) || O),
                (v.stop = x > 0 && Math.abs(M[d] - w[d]) > p),
                m && ((v.parsed = M), (v.raw = c.data[x])),
                u &&
                    (v.options =
                        h ||
                        this.resolveDataElementOptions(
...
var Oe = class extends dt {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            i = this.chart,
            n = i.data.labels || [],
            r = _e(e._parsed[t].r, i.options.locale);
        return { label: n[t] || '', value: r };
    }
    parseObjectData(t, e, i, n) {
        return Pi.bind(this)(t, e, i, n);
    }
    update(t) {
        let e = this._cachedMeta.data;
    ...
    updateElements(t, e, i, n) {
        ...
        for (g = e; g < e + i; g++) {
            let p = t[g],
                b = f,
                y = f + this._computeAngle(g, n, m),
                _ = o.getDataVisibility(g)
    ...
    _computeAngle(t, e, i) {
        return this.chart.getDataVisibility(t)
            ? ut(this.resolveDataElementOptions(t, e).angle || i)
            : 0;
    }
};
(S(Oe, 'id', 'polarArea'),
...
var Ge = class extends dt {
    ...
    updateElements(t, e, i, n) {
        let r = n === 'reset',
            ...
            b = se(m) ? m : Number.POSITIVE_INFINITY,
        ...
        for (let w = e; w < e + i; ++w) {
            ...
            ((v.skip = isNaN(O) || isNaN(D) || M),
                (v.stop = w > 0 && Math.abs(k[f] - _[f]) > b),
                p && ((v.parsed = k), (v.raw = c.data[w])),
                d &&
                    (v.options =
                        u ||
                        this.resolveDataElementOptions(
...
function yu(s, t, e, i) {
    ...
    function r(o, a, l) {
        let { startAngle: c, endAngle: h } = o.getProps(
            ...
            { angle: u } = bi(o, { x: t.x, y: t.y });
        xe(u, c, h) && n.push({ element: o, datasetIndex: a, index: l });
    }
    return (Zs(s, e, t, r), n);
}
function xu(s, t, e, i, n, r) {
    ...
    function c(h, u, d) {
        ...
        if (!(!!r || s.isPointInArea(g)) && !f) return;
        let p = a(t, g);
        p < l
        ...
        modes: {
            index(s, t, e, i) {
                let n = Ut(t, s),
                    ...
                    a = e.intersect ? sr(s, n, r, i, o) : ir(s, n, r, !1, i, o),
                    l = [];
                return a.length
            ...
            nearest(s, t, e, i) {
                let n = Ut(t, s),
                    r = e.axis || 'xy',
                    o = e.includeInvisible || !1;
                return ir(s, n, r, e.intersect, i, o);
            },
            x(s, t, e, i) {
                let n = Ut(t, s);
    ...
    for (let a of s) {
        ...
        if (a.horizontal) {
            ...
            (be(c.start) && (o = c.start),
                l.fullSize
                    ? Vi(l, n.left, o, e.outerWidth - n.right - n.left, d)
                    : Vi(l, t.left + c.placed, o, u, d),
                (c.start = o),
                (c.placed += u),
                (o = l.bottom));
        } else {
            ...
            (be(c.start) && (r = c.start),
                l.fullSize
                    ? Vi(l, r, n.top, d, e.outerHeight - n.bottom - n.top)
                    : Vi(l, r, t.top + c.placed, d, u),
                (c.start = r),
                (c.placed += u),
                (r = l.right));
        }
...
function Eu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((r) => {
            let o = !1;
            for (let a of r)
                ((o = o || Gi(a.addedNodes, i)),
                    (o = o && !Gi(a.removedNodes, i)));
            o && e();
        });
...
function Wi(s, t, e, i, n) {
    let r = P(i, 0),
        o = Math.min(P(n, s.length), s.length),
        a = 0,
        l,
        c,
        h;
...
var Ce = class s extends ft {
        ...
        generateTickLabels(t) {
            ...
            for (i = 0, n = t.length; i < n; i++)
                ((r = t[i]), (r.label = W(e.callback, [r.value, i, t], this)));
        }
        ...
        calculateLabelRotation() {
            ...
            let h = this._getLabelSizes(),
                u = h.widest.width,
                d = h.highest.height,
                f = K(this.chart.width - u, 0, this.maxWidth);
            ((a = t.offset ? this.maxWidth / i : f / (i - 1)),
                u + 6 > a &&
                    ...
                    (o = ks(
                        Math.min(
                            Math.asin(K((h.highest.height + 6) / a, -1, 1)),
                            Math.asin(K(l / c, -1, 1)) -
                                Math.asin(K(d / c, -1, 1)),
                        ),
                    )),
            ...
            if (o) {
                ...
                if (
                    (a
                        ...
                        : ((t.height = this.maxHeight), (t.width = Ls(r) + l)),
                    ...
                    let {
                        ...
                        p = Math.sin(g);
                    if (a) {
                        let b = i.mirror ? 0 : p * u.width + m * d.height;
                        t.height = Math.min(this.maxHeight, t.height + b + f);
                    } else {
                        let b = i.mirror ? 0 : m * u.width + p * d.height;
        ...
        getPixelForDecimal(t) {
            ...
            return Ln(this._alignToPixels ? Ht(this.chart, e, 0) : e);
        }
        ...
        _computeLabelItems(t) {
            let e = this.axis,
                ...
                J = 'middle';
            if (n === 'top')
                ((k = this.bottom - g), (v = this._getXAxisLabelAlignment()));
            else if (n === 'bottom')
                ((k = this.top + g), (v = this._getXAxisLabelAlignment()));
            else if (n === 'left') {
            ...
            e === 'y' &&
                (l === 'start' ? (J = 'top') : l === 'end' && (J = 'bottom'));
            let ht = this._getLabelSizes();
            for (b = 0, y = a.length; b < y; ++b) {
                ((_ = a[b]), (w = _.label));
                let V = r.setContext(this.getContext(b));
                ((M = this.getPixelForTick(b) + r.labelOffset),
                    ...
                    ? ((x = M),
                      ...
                      n === 'top'
                          ? c === 'near' || m !== 0
                              ? (L = -A * D + D / 2)
                              : c === 'center'
                                ? (L = -ht.highest.height / 2 - U * D + D)
                                : (L = -ht.highest.height + D / 2)
                          : c === 'near' || m !== 0
                            ? (L = D / 2)
                            : c === 'center'
                              ? (L = ht.highest.height / 2 - U * D)
                              : (L = ht.highest.height - A * D),
                      u && (L *= -1),
                      m !== 0 &&
                          !V.showLabelBackdrop &&
                          (x += (D / 2) * Math.sin(m)))
        ...
        drawBorder() {
            ...
            if (!o) return;
            let a = n.setContext(this.getContext(0)).lineWidth,
                l = this._borderValue,
                c,
                h,
                u,
                d;
            (this.isHorizontal()
                ? ((c = Ht(t, this.left, o) - o / 2),
                  (h = Ht(t, this.right, a) + a / 2),
                  (u = d = l))
                : ((u = Ht(t, this.top, o) - o / 2),
                  (d = Ht(t, this.bottom, a) + a / 2),
                  (c = h = l)),
                e.save(),
                (e.lineWidth = r.width),
    ...
    mr = class {
        ...
        _notify(t, e, i, n) {
            ...
            for (let r of t) {
                let o = r.plugin,
                    a = o[i],
                    l = [e, n, r.options];
                if (W(a, l, o) === !1 && n.cancelable) return !1;
            }
            return !0;
        }
        invalidate() {
        ...
        _notifyStateChanges(t) {
            let e = this._oldCache || [],
                ...
                n = (r, o) =>
                    r.filter(
                        (a) => !o.some((l) => a.plugin.id === l.plugin.id),
                    );
...
function sd(s) {
    ...
    for (let r = 0; r < i.length; r++) e.push(Nt.getPlugin(i[r]));
    let n = s.plugins || [];
...
var Fs = (s, t, e) => {
    ...
    yr = class {
        ...
        datasetScopeKeys(t) {
            return Bi(t, () => [[`datasets.${t}`, '']]);
        }
        datasetAnimationScopeKeys(t, e) {
            return Bi(`${t}.transition.${e}`, () => [
        ...
        getOptionScopes(t, e, i) {
            ...
            let l = new Set();
            e.forEach((h) => {
                (t && (l.add(t), h.forEach((u) => Fs(l, t, u))),
                    h.forEach((u) => Fs(l, n, u)),
                    h.forEach((u) => Fs(l, ie[r] || {}, u)),
                    h.forEach((u) => Fs(l, j, u)),
                    h.forEach((u) => Fs(l, Mi, u)));
            });
            let c = Array.from(l);
            return (
        ...
        chartOptionScopes() {
            ...
            return [t, ie[e] || {}, j.datasets[e] || {}, { type: e }, j, Mi];
        }
...
var xt = class {
    ...
    constructor(t, e) {
        ...
        if (
            ...
            (this.scales = {}),
            (this._plugins = new mr()),
            (this.$proxies = {}),
            (this._hiddenIndices = {}),
            (this.attached = !1),
            (this._animationsDisabled = void 0),
            (this.$context = void 0),
            (this._doResize = zn((u) => this.update(u), o.resizeDelay || 0)),
            (this._dataChanges = []),
            (Yi[this.id] = this),
            !a || !l)
        ) {
    ...
    _checkEventBindings() {
        let t = this.options,
            ...
            i = new Set(t.events);
        (!fi(e, i) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _getUniformDataChanges() {
        ...
        let e = this.data.datasets.length,
            ...
            n = i(0);
        for (let r = 1; r < e; r++) if (!fi(n, i(r))) return;
        return Array.from(n)
            .map((r) => r.split(','))
    ...
    getContext() {
        return (
            this.$context ||
            (this.$context = Ft(null, { chart: this, type: 'chart' }))
        );
    }
    ...
    _stop() {
        let t, e;
        for (
            this.stop(), Yt.remove(this), t = 0, e = this.data.datasets.length;
            t < e;
            ++t
        )
    ...
    unbindEvents() {
        (N(this._listeners, (t, e) => {
            ...
            (this._listeners = {}),
            N(this._responsiveListeners, (t, e) => {
                this.platform.removeEventListener(this, e, t);
            }),
            (this._responsiveListeners = void 0));
    }
...
function xd(s, t, e) {
    let {
        ...
        u = Math.min(c / o, tt(i - e));
    if ((s.beginPath(), s.arc(n, r, o - c / 2, i + u / 2, e - u / 2), a > 0)) {
        let d = Math.min(c / a, tt(i - e));
        s.arc(n, r, a + c / 2, e - d / 2, i + d / 2, !0);
    } else {
        let d = Math.min(c / 2, o * tt(i - e));
        if (h === 'round') s.arc(n, r, d, e - F / 2, i + F / 2, !0);
        else if (h === 'bevel') {
            let f = 2 * d * d,
                g = -f * Math.cos(e + F / 2) + n,
                m = -f * Math.sin(e + F / 2) + r,
                p = f * Math.cos(i + F / 2) + n,
                b = f * Math.sin(i + F / 2) + r;
...
function kd(s, t, e, i) {
    let n = wd(s.options.borderRadius),
        ...
        a = (l) => {
            ...
            return K(l, 0, Math.min(r, c));
        };
    return {
        outerStart: a(n.outerStart),
        outerEnd: a(n.outerEnd),
        innerStart: K(n.innerStart, 0, o),
...
function Xi(s, t, e, i, n, r) {
    ...
    let m = Math.max(0.001, g * u - e / F) / u,
        p = (g - m) / 2,
        b = l + p + f,
        y = n - p - f,
        {
    ...
    if ((s.beginPath(), r)) {
        ...
        s.moveTo(o, a);
        let V = Math.cos(O) * u + o,
            U = Math.sin(O) * u + a;
        s.lineTo(V, U);
        let G = Math.cos(D) * u + o,
            St = Math.sin(D) * u + a;
        s.lineTo(G, St);
    }
    s.closePath();
...
var Me = class extends ft {
    ...
    inRange(e, i, n) {
        let r = this.getProps(['x', 'y'], n),
            { angle: o, distance: a } = bi(r, { x: e, y: i }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
    ...
    draw(e) {
        ...
        if (
            ...
            (this.fullCircles = n > H ? Math.floor(n / H) : 0),
        ...
        let c = 1 - Math.sin(Math.min(F, n || 0)),
            h = r * c;
...
(S(Me, 'id', 'arc'),
    ...
    S(Me, 'defaultRoutes', { backgroundColor: 'backgroundColor' }),
    S(Me, 'descriptors', {
        _scriptable: !0,
...
function Od(s, t, e, i) {
    ...
    for (f = 0; f <= c; ++f)
        ((g = n[(a + (d ? c - f : f)) % o]),
            !g.skip &&
                (u ? (s.moveTo(g.x, g.y), (u = !1)) : h(s, m, g, d, r.stepped),
                (m = g)));
    return (
        l && ((g = n[(a + (d ? c : 0)) % o]), h(s, m, g, d, r.stepped)), !!l
    );
}
function Dd(s, t, e, i) {
    let n = t.points,
...
var zt = class extends ft {
    ...
    updateControlPoints(t, e) {
        ...
        if (
            ...
            (Yn(this._points, i, t, n, e), (this._pointsUpdated = !0));
        }
    }
    set points(t) {
        ((this._points = t),
    ...
    get segments() {
        return (
            this._segments || (this._segments = Jn(this, this.options.segment))
        );
    }
    first() {
        let t = this.segments,
...
var Je = class extends ft {
    ...
    inRange(t, e, i) {
        return rr(this, t, e, i);
    }
    inXRange(t, e) {
        return rr(this, t, null, e);
    }
    inYRange(t, e) {
        return rr(this, null, t, e);
    }
    getCenterPoint(t) {
        let {
            x: e,
...
function Zd(s, t, e, i, n) {
    ...
    for (o[l++] = s[h], u = 0; u < r - 2; u++) {
        ...
        let k = Math.floor(u * a) + 1 + t,
            v = Math.min(Math.floor((u + 1) * a) + 1, e) + t,
            { x: M, y: O } = s[h];
        for (f = g = -1, y = k; y < v; y++)
            ((g =
                0.5 *
                Math.abs((M - p) * (s[y].y - O) - (M - s[y].x) * (b - O))),
                g > f && ((f = g), (d = s[y]), (m = y)));
        ((o[l++] = d), (h = m));
    }
    return ((o[l++] = s[c]), o);
...
function qd(s, t, e, i) {
    let n = 0,
        ...
        w = s[b].x - y;
    for (o = t; o < t + e; ++o) {
        ((a = s[o]), (l = ((a.x - y) / w) * i), (c = a.y));
        let x = l | 0;
        if (x === h)
            (c < g ? ((g = c), (u = o)) : c > m && ((m = c), (d = o)),
                (n = (r * n + a.x) / ++r));
        else {
            let k = o - 1;
            if (!I(u) && !I(d)) {
...
function Gd(s, t) {
    ...
    return (
        l && (i = K(Mt(t, r.axis, o).lo, 0, e - 1)),
        c ? (n = K(Mt(t, r.axis, a).hi + 1, i, e) - i) : (n = e - i),
        { start: i, count: n }
    );
}
var Xd = {
...
function pf(s, t, e, i) {
    ...
    if (r === 'x' || r === 'y') {
        let l, c, h, u;
        (r === 'x'
            ? ((l = o), (c = n.top), (h = a), (u = n.bottom))
            : ((l = n.left), (c = o), (h = n.right), (u = a)),
            s.beginPath(),
            e &&
                ((l = Math.max(l, e.left)),
    ...
    Ki = class extends ft {
        ...
        buildLabels() {
            let t = this.options.labels || {},
                e = W(t.generateLabels, [this.chart], this) || [];
        ...
        _fitRows(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((g, m) => {
                    let p = i + e / 2 + r.measureText(g.text).width;
                    ((m === 0 || c[c.length - 1] + p + 2 * a > o) &&
                        ((u += h),
        ...
        adjustHitBoxes() {
            ...
            let t = this._computeTitleHeight(),
                ...
                o = ne(r, this.left, this.width);
            if (this.isHorizontal()) {
                let a = 0,
                    l = et(i, this.left + n, this.right - this.lineWidths[a]);
                for (let c of e)
                    (a !== c.row &&
                        ((a = c.row),
                        (l = et(
        ...
        _draw() {
                ...
                b = function (k, v, M) {
                    ...
                    if (
                        ...
                        let D = {
                            ...
                            A = l.xPlus(k, g / 2),
                            L = v + d;
                        Oi(n, D, A, L, o.pointStyleWidth && g);
                    } else {
                        let D = v + Math.max((u - m) / 2, 0),
                            A = l.leftForLtr(k, g),
                            L = jt(M.borderRadius);
                        (n.beginPath(),
                            Object.values(L).some((J) => J !== 0)
                                ? we(n, { x: A, y: D, w: g, h: m, radius: L })
                                : n.rect(A, D, g, m),
                            n.fill(),
                            O !== 0 && n.stroke());
                    }
            ...
            (_
                ? (f = {
                      x: et(r, this.left + h, this.right - i[0]),
                      y: this.top + h + w,
                      line: 0,
                  })
                : (f = {
                      x: this.left + h,
                      y: et(r, this.top + w + h, this.bottom - e[0].height),
                      line: 0,
                  }),
            ...
            (this.legendItems.forEach((k, v) => {
                ...
                let M = n.measureText(k.text).width,
                    O = l.textAlign(k.textAlign || (k.textAlign = o.textAlign)),
                    D = g + d + M,
                    A = f.x,
                    L = f.y;
                (l.setWidth(this.width),
                    _
                        ? v > 0 &&
                          ...
                          f.line++,
                          (A = f.x =
                              et(r, this.left + h, this.right - i[f.line])))
                        : v > 0 &&
                          L + x > this.bottom &&
                ...
                if (
                    (b(J, L, k),
                    (A = Vn(O, A + g + d, _ ? A + D : this.right, t.rtl)),
                    y(l.x(A), L, k),
                    _)
                )
                    f.x += D + h;
        ...
        drawTitle() {
            let t = this.options,
                ...
                n = st(e.padding);
            if (!e.display) return;
            let r = ne(t.rtl, this.left, this.width),
                o = this.ctx,
                a = e.position,
                l = i.size / 2,
                c = n.top + l,
        ...
        _getLegendItemAt(t, e) {
            ...
            if (Dt(t, this.left, this.right) && Dt(e, this.top, this.bottom)) {
                for (r = this.legendHitBoxes, i = 0; i < r.length; ++i)
                    if (
                        ((n = r[i]),
                        Dt(t, n.left, n.left + n.width) &&
                            Dt(e, n.top, n.top + n.height))
                    )
...
function _f(s, t, e, i) {
    ...
    return (
        n &&
            typeof n != 'string' &&
            (n = n.reduce((r, o) => (r.length > o.length ? r : o))),
...
var vf = {
        ...
        _element: Ki,
        start(s, t, e) {
            let i = (s.legend = new Ki({ ctx: s.ctx, options: e, chart: s }));
            (ot.configure(s, i, e), ot.addBox(s, i));
        },
        stop(s) {
            (ot.removeBox(s, s.legend), delete s.legend);
        },
        beforeUpdate(s, t, e) {
            let i = s.legend;
            (ot.configure(s, i, e), (i.options = e));
        },
        afterUpdate(s) {
            let t = s.legend;
    ...
    Us = class extends ft {
        ...
        update(t, e) {
            ...
            let n = B(i.text) ? i.text.length : 1;
            this._padding = st(i.padding);
            let r = n * X(i.font).lineHeight + this._padding.height;
        ...
        _drawArgs(t) {
            ...
            return (
                this.isHorizontal()
                    ? ((h = et(a, i, r)), (u = e + t), (c = r - i))
                    : (o.position === 'left'
                          ? ((h = i + t), (u = et(a, n, e)), (l = F * -0.5))
                          : ((h = r - t), (u = et(a, e, n)), (l = F * 0.5)),
                      (c = n - e)),
...
var Mf = {
        ...
        stop(s) {
            let t = s.titleBlock;
            (ot.removeBox(s, t), delete s.titleBlock);
        },
        beforeUpdate(s, t, e) {
            let i = s.titleBlock;
            (ot.configure(s, i, e), (i.options = e));
    ...
    Tf = {
        ...
        start(s, t, e) {
            ...
            (ot.configure(s, i, e), ot.addBox(s, i), Hi.set(s, i));
        },
        stop(s) {
            (ot.removeBox(s, Hi.get(s)), Hi.delete(s));
        },
        beforeUpdate(s, t, e) {
            let i = Hi.get(s);
            (ot.configure(s, i, e), (i.options = e));
    ...
    zs = {
        average(s) {
            ...
            return r === 0 || i.size === 0
                ? !1
                : { x: [...i].reduce((a, l) => a + l) / i.size, y: n / r };
        },
        nearest(s, t) {
            if (!s.length) return !1;
            let e = t.x,
...
function Rt(s, t) {
    return (t && (B(t) ? Array.prototype.push.apply(s, t) : s.push(t)), s);
}
function Zt(s) {
...
function Ma(s, t) {
    ...
    return (
        ...
        N(s.title, _),
        (e.font = l.string),
        N(s.beforeBody.concat(s.afterBody), _),
        (y = t.displayColors ? o + 2 + t.boxPadding : 0),
        N(i, (w) => {
            (N(w.before, _), N(w.lines, _), N(w.after, _));
        }),
        (y = 0),
        (e.font = h.string),
        N(s.footer, _),
...
function Oa(s, t, e, i) {
    ...
    return (
        ...
        { x: K(g, 0, i.width - t.width), y: K(m, 0, i.height - t.height) }
    );
}
function $i(s, t, e) {
    let i = st(e.padding);
...
var $s = class extends ft {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (r = { opacity: 0 });
            ...
            let a = zs[i.position].call(this, n, this._eventPosition);
    ...
    getCaretPosition(t, e, i) {
        let { xAlign: n, yAlign: r } = this,
            ...
            { topLeft: l, topRight: c, bottomLeft: h, bottomRight: u } = jt(a),
            { x: d, y: f } = t,
            { width: g, height: m } = e,
            p,
            b,
        ...
        return (
            r === 'center'
                ? ((w = f + m / 2),
                  n === 'left'
                      ? ((p = d), (b = p - o), (_ = w + o), (x = w - o))
                      : ((p = d + g), (b = p + o), (_ = w - o), (x = w + o)),
                  (y = p))
                : (n === 'left'
                      ? (b = d + Math.max(l, h) + o)
                      : n === 'right'
                        ? (b = d + g - Math.max(c, u) - o)
                        : (b = this.caretX),
                  r === 'top'
                      ? ((_ = f), (w = _ - o), (p = b - o), (y = b + o))
                      : ((_ = f + m), (w = _ + o), (p = b + o), (y = b - o)),
                  (x = _)),
    ...
    drawTitle(t, e, i) {
        let n = this.title,
            ...
            l;
        if (r) {
            let c = ne(i.rtl, this.x, this.width);
            for (
                t.x = $i(this, i.titleAlign, i),
    ...
    _drawColorBox(t, e, i, n, r) {
        ...
        if (r.usePointStyle) {
            ...
            let m = n.leftForLtr(d, c),
                p = n.leftForLtr(n.xPlus(d, 1), c - 2),
                b = jt(o.borderRadius);
            Object.values(b).some((y) => y !== 0)
                ? (t.beginPath(),
                  (t.fillStyle = r.multiKeyBackground),
                  we(t, { x: m, y: g, w: c, h: l, radius: b }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = o.backgroundColor),
                  t.beginPath(),
                  we(t, { x: p, y: g + 1, w: c - 2, h: l - 2, radius: b }),
                  t.fill())
                : ((t.fillStyle = r.multiKeyBackground),
                  t.fillRect(m, g, c, l),
    ...
    drawBody(t, e, i) {
        let { body: n } = this,
            ...
            d = u.lineHeight,
            f = 0,
            g = ne(i.rtl, this.x, this.width),
            m = function (M) {
                (e.fillText(M, g.x(t.x + f), t.y + d / 2), (t.y += d + r));
            },
            p = g.textAlign(o),
            b,
            y,
        ...
        ((f = 0), (d = u.lineHeight), N(this.afterBody, m), (t.y -= r));
    }
    drawFooter(t, e, i) {
        let n = this.footer,
            r = n.length,
            ...
            a;
        if (r) {
            let l = ne(i.rtl, this.x, this.width);
            for (
                t.x = $i(this, i.footerAlign, i),
...
var Lf = {
        ...
        positioners: zs,
        afterInit(s, t, e) {
            e && (s.tooltip = new $s({ chart: s, options: e }));
        },
        beforeUpdate(s, t, e) {
...
var Vs = class extends Ce {
    ...
    init(t) {
        ...
        if (e.length) {
            ...
            for (let { index: n, label: r } of e) i[n] === r && i.splice(n, 1);
            this._addedLabels = [];
        }
        super.init(t);
    }
...
function Bf(s, { min: t, max: e }) {
    ...
    let i = [],
        ...
        u = Math.floor((c - h) / Math.pow(10, r)),
        d = at(s.min, Math.round((l + h + u * Math.pow(10, r)) * o) / o);
    for (; d < e; )
        (i.push({ value: d, major: Ia(d), significand: u }),
            u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
            u >= 20 && (r++, (u = 2), (o = r >= 0 ? 1 : o)),
            (d = Math.round((l + h + u * Math.pow(10, r)) * o) / o));
    let f = at(s.max, d);
    return (i.push({ value: f, major: Ia(f), significand: u }), i);
}
var Bs = class extends Ce {
    ...
    parse(t, e) {
        ...
        return Y(i) && i > 0 ? i : null;
    }
    determineDataLimits() {
        let { min: t, max: e } = this.getMinMax(!0);
        ((this.min = Y(t) ? Math.max(0, t) : null),
            (this.max = Y(e) ? Math.max(0, e) : null),
            this.options.beginAtZero && (this._zero = !0),
            this._zero &&
                this.min !== this._suggestedMin &&
                !Y(this._userMin) &&
                (this.min =
                    t === Se(this.min, 0) ? Se(this.min, -1) : Se(this.min, 0)),
            this.handleTickRangeOptions());
    }
    handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            r = (a) => (i = t ? i : a),
            o = (a) => (n = e ? n : a);
        (i === n && (i <= 0 ? (r(1), o(10)) : (r(Se(i, -1)), o(Se(n, 1)))),
            i <= 0 && r(Se(n, -1)),
            n <= 0 && o(Se(i, 1)),
            (this.min = i),
            (this.max = n));
    ...
    getLabelForValue(t) {
        return t === void 0
            ? '0'
            : _e(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
        let t = this.min;
        (super.configure(),
...
function Zf(s, t, e) {
    let i = [],
        ...
        l = { extra: kr(r) / 2, additionalAngle: o ? F / n : 0 },
        c;
    for (let h = 0; h < n; h++) {
...
var Te = class extends Qe {
    ...
    setDimensions() {
        let t = (this._padding = st(kr(this.options) / 2)),
    ...
    determineDataLimits() {
        ...
        ((this.min = Y(t) && !isNaN(t) ? t : 0),
            (this.max = Y(e) && !isNaN(e) ? e : 0),
            this.handleTickRangeOptions());
    }
    computeTickLimit() {
    ...
    getPointPosition(t, e, i = 0) {
        let n = this.getIndexAngle(t) - q + i;
        return {
    ...
    drawGrid() {
        let t = this.ctx,
            e = this.options,
            { angleLines: i, grid: n, border: r } = e,
        ...
        if (
            ...
            for (t.save(), a = o - 1; a >= 0; a--) {
                let h = i.setContext(this.getPointLabelContext(a)),
...
function Ra(s, t) {
    ...
    return (
        ...
        Y(o) || (o = typeof i == 'string' ? e.parse(o, i) : e.parse(o)),
        o === null
            ? null
            : (n &&
                  (o =
...
function Na(s, t, e, i) {
    ...
    for (let r = ct.indexOf(s); r < n - 1; ++r) {
        ...
        if (o.common && Math.ceil((e - t) / (a * o.size)) <= i) return ct[r];
    }
    return ct[n - 1];
}
...
var De = class extends Ce {
    ...
    init(t, e = {}) {
        let i = t.time || (t.time = {}),
            n = (this._adapter = new vr._date(t.adapters.date));
        (n.init(e),
    ...
    determineDataLimits() {
        ...
        ((!o || !a) &&
            ...
            (t.bounds !== 'ticks' || t.ticks.source !== 'labels') &&
                l(this.getMinMax(!1))),
            (n = Y(n) && !isNaN(n) ? n : +e.startOf(Date.now(), i)),
            (r = Y(r) && !isNaN(r) ? r : +e.endOf(Date.now(), i) + 1),
    ...
    _tickFormatFunction(t, e, i, n) {
        let r = this.options,
            o = r.ticks.callback;
        if (o) return W(o, [t, e, i], this);
        let a = r.time.displayFormats,
            l = this._unit,
            c = this._majorUnit,
            h = l && a[l],
            u = c && a[c],
    ...
    _getLabelSize(t) {
        let e = this.options.ticks,
            ...
            n = ut(this.isHorizontal() ? e.maxRotation : e.minRotation),
            r = Math.cos(n),
            o = Math.sin(n),
...
function ji(s, t, e) {
    ...
    e
        ? (t >= s[i].pos &&
              t <= s[n].pos &&
              ({ lo: i, hi: n } = Mt(s, 'pos', t)),
          ({ pos: r, time: a } = s[i]),
          ({ pos: o, time: l } = s[n]))
        : (t >= s[i].time &&
              t <= s[n].time &&
              ({ lo: i, hi: n } = Mt(s, 'time', t)),
          ({ time: r, pos: a } = s[i]),
          ({ time: o, pos: l } = s[n]));
    let c = o - r;
...
function zr(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = Nr.get(e);
    return (
        i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), Nr.set(e, i)), i
    );
}
var Vr = new Map();
function dg(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = Vr.get(e);
    return (
        i === void 0 && ((i = new Intl.NumberFormat(s, t)), Vr.set(e, i)), i
    );
}
var Wr = new Map();
function fg(s, t = {}) {
    let { base: e, ...i } = t,
        ...
        r = Wr.get(n);
    return (
        r === void 0 && ((r = new Intl.RelativeTimeFormat(s, t)), Wr.set(n, r)),
        r
    );
}
var Gs = null;
...
function sc(s) {
    ...
    return (
        t === void 0 &&
            ((t = new Intl.DateTimeFormat(s).resolvedOptions()), Br.set(s, t)),
        t
    );
}
var Hr = new Map();
...
function pg(s) {
    ...
    if (e === -1) return [s];
    {
        let i, n;
        try {
            ((i = zr(s).resolvedOptions()), (n = s));
        } catch {
            let l = s.substring(0, e);
            ((i = zr(l).resolvedOptions()), (n = l));
        }
...
var $r = class {
        ...
        format(t) {
            if (this.inf) {
                ...
                let e = this.floor ? Math.floor(t) : eo(t, 3);
                ...
                t.zone.type === 'system'
                    ...
                    : t.zone.type === 'iana'
                      ...
                      : ((n = 'UTC'),
                        ...
                        (this.originalZone = t.zone));
            let r = { ...this.opts };
            ((r.timeZone = r.timeZone || n), (this.dtf = zr(e, r)));
        }
        format() {
    ...
    $ = class s {
        ...
        clone(t) {
            return !t || Object.getOwnPropertyNames(t).length === 0
                ...
                : s.create(
                      ...
                      qr(t.weekSettings) || this.weekSettings,
                      t.defaultToEN || !1,
                  );
        }
        redefaultToEN(t = {}) {
        ...
        numberFormatter(t = {}) {
            return new $r(this.intl, t.forceSimple || this.fastNumbers, t);
        }
        dtFormatter(t, e = {}) {
            return new jr(t, this.intl, e);
        }
        relFormatter(t = {}) {
    ...
    vt = class s extends Le {
        ...
        get name() {
            return this.fixed === 0 ? 'UTC' : `UTC${Ks(this.fixed, 'narrow')}`;
        }
        get ianaName() {
            return this.fixed === 0
                ? 'Etc/UTC'
    ...
    if (Tg(s)) {
        ...
        return e === 'default'
            ...
            : e === 'local' || e === 'system'
              ...
              : e === 'utc' || e === 'gmt'
                ? vt.utcInstance
                : vt.parseSpecifier(e) || he.create(s);
    } else
        return ce(s)
            ? vt.instance(s)
            : typeof s == 'object' &&
...
function xl(s, t) {
    if (!C(s.localWeekday) || !C(s.localWeekNumber) || !C(s.localWeekYear)) {
        ...
        return (
            C(s.localWeekday) || (s.weekday = s.localWeekday),
            C(s.localWeekNumber) || (s.weekNumber = s.localWeekNumber),
            C(s.localWeekYear) || (s.weekYear = s.localWeekYear),
...
function qr(s) {
    ...
    if (typeof s != 'object') throw new it('Week settings must be an object');
    if (
        !kt(s.firstDay, 1, 7) ||
        !kt(s.minimalDays, 1, 7) ||
        !Array.isArray(s.weekend) ||
        s.weekend.some((t) => !kt(t, 1, 7))
    )
        ...
        formatDurationFromString(t, e) {
            let i = this.opts.signMode === 'negativeLargestOnly' ? -1 : 1,
                ...
                r = (h, u) => (d) => {
                    ...
                    if (f) {
                        let g =
                                u.isNegativeDuration && f !== u.largestUnit
                                    ? i
                                    : 1,
                            m;
                        return (
                ...
                l = t.shiftTo(...a.map(n).filter((h) => h)),
                c = {
...
function kc(...s) {
    return (t, e) => {
        let i = {},
            n;
        for (n = 0; n < s.length; n++) i[s[n]] = oe(t[e + n]);
        return [i, null, e + n];
    };
}
var vc = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/,
...
var nt = class s {
        ...
        static invalid(t, e = null) {
            ...
            if (Z.throwOnInvalid) throw new Fr(i);
        ...
        toISO() {
            ...
            return (
                ...
                (this.seconds !== 0 || this.milliseconds !== 0) &&
                    (t += eo(this.seconds + this.milliseconds / 1e3, 3) + 'S'),
                t === 'P' && (t += 'T0S'),
                t
            );
        }
        ...
        plus(t) {
            ...
            let e = s.fromDurationLike(t),
                i = {};
            for (let n of Ee)
                (as(e.values, n) || as(this.values, n)) &&
                    (i[n] = e.get(n) + this.get(n));
            return Gt(this, { values: i }, !0);
        }
        minus(t) {
            if (!this.isValid) return this;
            let e = s.fromDurationLike(t);
        ...
        set(t) {
            if (!this.isValid) return this;
            let e = { ...this.values, ...gn(t, s.normalizeUnit) };
            return Gt(this, { values: e });
        }
        reconfigure({
            locale: t,
            numberingSystem: e,
        ...
        equals(t) {
            ...
            for (let i of Ee) if (!e(this.values[i], t.values[i])) return !1;
            return !0;
        }
    },
    es = 'Invalid Interval';
function Cm(s, t) {
    return !s || !s.isValid
        ...
        : !t || !t.isValid
          ? os.invalid('missing or invalid end')
          : t < s
            ? os.invalid(
                  'end before start',
...
var os = class s {
        ...
        static invalid(t, e = null) {
            ...
            let i = t instanceof mt ? t : new mt(t, e);
            if (Z.throwOnInvalid) throw new Lr(i);
            return new s({ invalid: i });
        }
        ...
        static fromISO(t, e) {
            ...
            if (i && n) {
                ...
                if (o && l) return s.fromDateTimes(r, a);
                if (o) {
                    let c = nt.fromISO(n, e);
                    if (c.isValid) return s.after(r, c);
                } else if (l) {
                    let c = nt.fromISO(i, e);
        ...
        set({ start: t, end: e } = {}) {
            return this.isValid
                ? s.fromDateTimes(t || this.s, e || this.e)
                : this;
        }
        splitAt(...t) {
            ...
            for (; n < this.e; ) {
                let o = e[r] || this.e,
                    a = +o > +this.e ? this.e : o;
                (i.push(s.fromDateTimes(n, a)), (n = a), (r += 1));
            }
            return i;
        }
        splitBy(t) {
            ...
            for (let l of a)
                ((i += l.type === 's' ? 1 : -1),
                    i === 1
                        ...
                        : (e &&
                              +e != +l.time &&
                              n.push(s.fromDateTimes(e, l.time)),
                          (e = null)));
            return s.merge(n);
        }
        difference(...t) {
        ...
        toLocaleString(t = hn, e = {}) {
            return this.isValid
                ? gt.create(this.s.loc.clone(e), t).formatInterval(this)
                : es;
        }
        toISO(t) {
            return this.isValid ? `${this.s.toISO(t)}/${this.e.toISO(t)}` : es;
        }
        toISODate() {
            return this.isValid
    ...
    is = class {
        static hasDST(t = Z.defaultZone) {
            let e = R.now().setZone(t).set({ month: 12 });
            return !t.isUniversal && e.offset !== e.set({ month: 6 }).offset;
        }
        static isValidIANAZone(t) {
            return he.isValidZone(t);
        }
        static normalizeZone(t) {
            return ae(t, Z.defaultZone);
        }
        static getStartOfWeek({ locale: t = null, locObj: e = null } = {}) {
            return (e || $.create(t)).getStartOfWeek();
        }
        static getMinimumDaysInFirstWeek({
            locale: t = null,
            locObj: e = null,
        } = {}) {
            return (e || $.create(t)).getMinDaysInFirstWeek();
        }
        static getWeekendWeekdays({ locale: t = null, locObj: e = null } = {}) {
            return (e || $.create(t)).getWeekendDays().slice();
        }
        static months(
            t = 'long',
            {
            ...
            return (n || $.create(e, i, r)).months(t);
        }
        static monthsFormat(
            t = 'long',
            {
            ...
            return (n || $.create(e, i, r)).months(t, !0);
        }
        static weekdays(
            t = 'long',
            {
            ...
            return (n || $.create(e, i, null)).weekdays(t);
        }
        static weekdaysFormat(
            ...
            return (n || $.create(e, i, null)).weekdays(t, !0);
        }
        static meridiems({ locale: t = null } = {}) {
            return $.create(t).meridiems();
        }
...
function Rm(s, t) {
    let e = Ct(t),
        ...
        m = ((p) => {
            ...
            switch (p.val) {
                case 'G':
                    return Pt(t.eras('short'), 0);
                case 'GG':
                    return Pt(t.eras('long'), 0);
                case 'y':
                    return z(c);
                case 'yy':
                    return z(u, Gr);
                ...
                case 'MM':
                    return z(i);
                case 'MMM':
                    return Pt(t.months('short', !0), 1);
                case 'MMMM':
                    return Pt(t.months('long', !0), 1);
                case 'L':
                    return z(a);
                case 'LL':
                    return z(i);
                case 'LLL':
                    return Pt(t.months('short', !1), 1);
                case 'LLLL':
                    return Pt(t.months('long', !1), 1);
                case 'd':
                    return z(a);
                case 'dd':
                    return z(i);
                ...
                case 'c':
                    return z(e);
                case 'EEE':
                    return Pt(t.weekdays('short', !1), 1);
                case 'EEEE':
                    return Pt(t.weekdays('long', !1), 1);
                case 'ccc':
                    return Pt(t.weekdays('short', !0), 1);
                case 'cccc':
...
function Bm(s) {
    let t = (r) => {
        ...
        i;
    return (
        C(s.z) || (e = he.create(s.z)),
        C(s.Z) || (e || (e = new vt(s.Z)), (i = s.Z)),
        C(s.q) || (s.M = (s.q - 1) * 3 + 1),
        C(s.h) ||
            (s.h < 12 && s.a === 1
                ? (s.h += 12)
...
function Pr(s) {
    return (s.weekData === null && (s.weekData = dn(s.c)), s.weekData);
}
function Ar(s) {
    return (
...
function ss(s, t, e, i, n, r) {
    ...
    if ((s && Object.keys(s).length !== 0) || t) {
        let l = t || a,
            c = R.fromObject(s, { ...e, zone: l, specificOffset: r });
        return o ? c : c.setZone(a);
    } else
        return R.invalid(
            new mt('unparsable', `the input "${n}" can't be parsed as ${i}`),
        );
}
function rn(s, t, e = !0) {
    return s.isValid
        ? gt
              .create($.create('en-US'), { allowZ: e, forceSimple: !0 })
...
function Il(s, t, e, i, n, r, o) {
    let a = !e || s.c.millisecond !== 0 || s.c.second !== 0,
        l = '';
    switch (o) {
        case 'day':
        case 'month':
        case 'year':
            break;
        default:
            if (((l += Q(s.c.hour)), o === 'hour')) break;
            if (t) {
                if (((l += ':'), (l += Q(s.c.minute)), o === 'minute')) break;
                a && ((l += ':'), (l += Q(s.c.second)));
            } else {
                if (((l += Q(s.c.minute)), o === 'minute')) break;
                a && (l += Q(s.c.second));
            }
            if (o === 'second') break;
            a &&
...
function Fl(s, t, e) {
    let i = C(e.round) ? !0 : e.round,
        ...
        r = (a, l) => (
            (a = eo(a, i || e.calendary ? 0 : 2, e.calendary ? 'round' : n)),
    ...
    for (let a of e.units) {
        let l = o(a);
        if (Math.abs(l) >= 1) return r(l, a);
    }
...
var Js,
    ...
    R = class s {
        constructor(t) {
            ...
            if (!i)
                if (t.old && t.old.ts === this.ts && t.old.zone.equals(e))
                    ...
                    let a = ce(t.o) && !t.old ? t.o : e.offset(this.ts);
                    ((n = nn(this.ts, a)),
                        (i = Number.isNaN(n.year)
                            ? new mt('invalid input')
                            : null),
                        (n = i ? null : n),
                        (r = i ? null : a));
                }
        ...
        static fromJSDate(t, e = {}) {
            ...
            return n.isValid
                ? new s({ ts: i, zone: n, loc: $.fromObject(e) })
                : s.invalid(Xs(n));
        }
        static fromMillis(t, e = {}) {
            if (ce(t))
        ...
        static fromObject(t, e = {}) {
            ...
            let n = $.fromObject(e),
                ...
                d = !C(r.month) || !C(r.day),
                f = u || d,
                g = r.weekYear || r.weekNumber;
            if ((f || h) && g)
                throw new le(
                    "Can't mix weekYear/weekNumber units with year/month/day or ordinals",
                );
            if (d && h) throw new le("Can't mix ordinal dates with month/day");
            let m = g || (r.weekday && !f),
                p,
                b,
                y = nn(l, c);
        ...
        get localWeekNumber() {
            return this.isValid ? Ar(this).weekNumber : NaN;
        }
        get localWeekYear() {
            return this.isValid ? Ar(this).weekYear : NaN;
        }
        get ordinal() {
            return this.isValid ? Or(this.c).ordinal : NaN;
        }
        get monthShort() {
            return this.isValid
                ? is.months('short', { locObj: this.loc })[this.month - 1]
                : null;
        }
        get monthLong() {
            return this.isValid
                ? is.months('long', { locObj: this.loc })[this.month - 1]
                : null;
        }
        get weekdayShort() {
            return this.isValid
                ? is.weekdays('short', { locObj: this.loc })[this.weekday - 1]
                : null;
        }
        get weekdayLong() {
            return this.isValid
                ? is.weekdays('long', { locObj: this.loc })[this.weekday - 1]
                : null;
        }
        get offset() {
        ...
        get daysInYear() {
            return this.isValid ? ns(this.year) : NaN;
        }
        get weeksInWeekYear() {
            return this.isValid ? Qs(this.weekYear) : NaN;
        }
        ...
        toUTC(t = 0, e = {}) {
            return this.setZone(vt.instance(t), e);
        }
        toLocal() {
            return this.setZone(Z.defaultZone);
        }
        setZone(t, { keepLocalTime: e = !1, keepCalendarTime: i = !1 } = {}) {
            if (((t = ae(t, Z.defaultZone)), t.equals(this.zone))) return this;
            if (t.isValid) {
                let n = this.ts;
                if (e || i) {
        ...
        diff(t, e = 'milliseconds', i = {}) {
            if (!this.isValid || !t.isValid)
                return nt.invalid('created by diffing an invalid DateTime');
            let n = {
                    locale: this.locale,
        ...
        until(t) {
            return this.isValid ? os.fromDateTimes(this, t) : this;
        }
        hasSame(t, e, i) {
        ...
        toRelative(t = {}) {
            if (!this.isValid) return null;
            let e = t.base || s.fromObject({}, { zone: this.zone }),
        ...
        static fromFormatParser(t, e, i = {}) {
            ...
            return h ? s.invalid(h) : ss(a, l, i, `format ${e.format}`, t, c);
        }
...
function qs(s) {
    ...
    if (s && s.valueOf && ce(s.valueOf())) return R.fromJSDate(s);
    ...
    return {
        ...
        initChart() {
            ...
            if (
                ...
                return;
            let i = getComputedStyle(this.$el).fontFamily,
                n = this.$refs.canvas.style.maxHeight !== '100%';
            (t ?? (t = {}),
                ...
                (c = t.scales.x.border).display ?? (c.display = !1),
                (h = t.scales.x).grid ?? (h.grid = {}),
                ...
                ['doughnut', 'pie', 'polarArea'].includes(e) &&
                    ((p = t.scales.x).display ?? (p.display = !1),
                    (b = t.scales.y).display ?? (b.display = !1),
                    (y = t.scales.y.grid).display ?? (y.display = !1),
                    t.elements ?? (t.elements = {}),
                    (_ = t.elements).arc ?? (_.arc = {}),
                    t.plugins ?? (t.plugins = {}),
                    (w = t.plugins).legend ?? (w.legend = {}),
                    (x = t.plugins.legend).labels ?? (x.labels = {}),
                    (k = t.plugins.legend.labels).generateLabels ??
                        (k.generateLabels = (A) => {
                            ...
                            for (let J of L)
                                J.strokeStyle = _n(J.fillStyle, 0.2);
                            return L;
                        })),
                e === 'polarArea' &&
                    ((v = t.scales).r ?? (v.r = {}),
                    (M = t.scales.r).grid ?? (M.grid = {}),
                    (O = t.scales.r).ticks ?? (O.ticks = {}),
        ...
        updateChartData(i) {
            let n = this.getChart();
            n && (this.normalizeDatasets(i), (n.data = i), n.update('resize'));
        },
        normalizeDatasets(i) {
            for (let n of i?.datasets ?? [])
                (e === 'bar' &&
                    n.backgroundColor !== void 0 &&
                    (n.borderColor ??
                        (n.borderColor = _n(n.backgroundColor, 0.2)),
                    n.hoverBorderColor ??
                        (n.hoverBorderColor = _n(n.backgroundColor, 0.3))),
                    e === 'scatter' &&
                        n.backgroundColor !== void 0 &&
                        (n.borderColor ?? (n.borderColor = n.backgroundColor)),
                    ['line', 'scatter'].includes(e) &&
                        n.borderColor !== void 0 &&
                        (n.pointBackgroundColor ??
                            (n.pointBackgroundColor = n.borderColor)));
        },
        updateChartTheme() {
            let i = this.getChart();
        ...
        applyChartColors(i) {
            ...
            ((i.backgroundColor = this.userBackgroundColor ?? n),
                ...
                (i.scales.y.grid.color = this.userYGridColor ?? a),
                e === 'polarArea' &&
                    ((i.scales.r.grid.color = this.userRadialGridColor ?? a),
                    (i.scales.r.ticks.color = this.userRadialTicksColor ?? o)));
        },
        handleDprChange() {
            let i = this.getChart();
            i &&
                i.currentDevicePixelRatio !== window.devicePixelRatio &&
                i.resize();
        },
        getChart() {
        ...
        getSurroundingBackgroundColor() {
            ...
            for (; i; ) {
                let n = getComputedStyle(i).backgroundColor;
