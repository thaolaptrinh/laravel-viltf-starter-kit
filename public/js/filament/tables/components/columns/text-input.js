function a({ name: i, recordKey: s, state: n }) {
    return {
        error: void 0,
        isLoading: !1,
        state: n,
        ...
        init() {
            ((this.unsubscribeLivewireHook = Livewire.interceptMessage(
                ...
                this.$watch('state', async () => {
                    let e = this.getServerState();
                    if (e === void 0 || this.getNormalizedState() === e) return;
                    this.isLoading = !0;
        ...
        getNormalizedState() {
            let e = Alpine.raw(this.state);
            return [null, void 0].includes(e) ? '' : e;
        },
        destroy() {
