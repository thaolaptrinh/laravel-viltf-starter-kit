(() => {
    ...
    function P(e) {
        let { x: t, y: o, width: n, height: s } = e;
        return {
            width: n,
            height: s,
            top: o,
    ...
    async function fe(e, t) {
        var o;
        t === void 0 && (t = {});
        let { x: n, y: s, platform: l, rects: i, elements: r, strategy: c } = e,
            {
            ...
            m = ce(f),
            w = r[h ? (u === 'floating' ? 'reference' : 'floating') : u],
            g = P(
                await l.getClippingRect({
                    element:
                        (o = await (l.isElement == null
                            ? void 0
                            : l.isElement(w))) == null || o
                            ? w
                            : w.contextElement ||
                              (await (l.getDocumentElement == null
                                  ? void 0
                                  : l.getDocumentElement(r.floating))),
                    boundary: a,
                    rootBoundary: d,
                    strategy: c,
                }),
    ...
    var Me = 50,
        de = async (e, t, o) => {
            let {
                ...
                r = i.detectOverflow ? i : { ...i, detectOverflow: fe },
            ...
            return { x: d, y: u, placement: h, strategy: s, middlewareData: m };
        };
    var $e = new Set(['left', 'top']);
    async function Ne(e, t) {
        let { placement: o, platform: n, elements: s } = e,
            l = await (n.isRTL == null ? void 0 : n.isRTL(s.floating)),
            i = Y(o),
            r = ee(o),
            c = z(o) === 'y',
            a = $e.has(i) ? -1 : 1,
        ...
        return (
            r && typeof m == 'number' && (f = r === 'end' ? m * -1 : m),
            c ? { x: f * d, y: h * a } : { x: h * a, y: f * d }
        );
    }
    var ue = function (e) {
            return (
                e === void 0 && (e = 0),
                {
                    ...
                    async fn(t) {
                        var o, n;
                        let { x: s, y: l, placement: i, middlewareData: r } = t,
                            c = await Ne(t, e);
                        return i ===
                            ((o = r.offset) == null ? void 0 : o.placement) &&
                            (n = r.arrow) != null &&
                            n.alignmentOffset
                            ? {}
                            : {
        ...
        he = function (e) {
            return (
                e === void 0 && (e = {}),
                {
                    ...
                    options: e,
                    async fn(t) {
                        let { x: o, y: n, placement: s, platform: l } = t,
                            {
                                mainAxis: i = !0,
                                crossAxis: r = !1,
                                limiter: c = {
    ...
    function A(e) {
        var t;
        return (t =
            (ge(e) ? e.ownerDocument : e.document) || window.document) == null
            ? void 0
            : t.documentElement;
    }
    function ge(e) {
    ...
    function B(e) {
        let { overflow: t, overflowX: o, overflowY: n, display: s } = C(e);
        return (
            /auto|scroll|overlay|hidden|clip/.test(t + n + o) &&
            s !== 'inline' &&
            s !== 'contents'
        );
    }
    ...
    var Ve = /transform|translate|scale|rotate|perspective|filter/,
    ...
    function J(e) {
        ...
        return (
            ...
            D(t.rotate) ||
            D(t.perspective) ||
            (!K() && (D(t.backdropFilter) || D(t.filter))) ||
            Ve.test(t.willChange || '') ||
            Be.test(t.contain || '')
        );
    }
    function we(e) {
    ...
    function V(e, t, o) {
        ...
        let s = xe(e),
            l = s === ((n = e.ownerDocument) == null ? void 0 : n.body),
            i = v(s);
        if (l) {
            let r = q(i);
            return t.concat(
    ...
    function Re(e) {
        let t = C(e),
            ...
            r = H(o) !== l || H(n) !== i;
        return (r && ((o = l), (n = i)), { width: o, height: n, $: r });
    }
    function oe(e) {
    ...
    function W(e) {
        ...
        let o = t.getBoundingClientRect(),
            { width: n, height: s, $: l } = Re(t),
            i = (l ? H(o.width) : o.width) / n,
            r = (l ? H(o.height) : o.height) / s;
        return (
    ...
    function Oe(e, t) {
        let o = e.getBoundingClientRect(),
            n = o.left + t.scrollLeft - Q(e, o),
            s = o.top + t.scrollTop;
        return { x: n, y: s };
    }
    function _e(e) {
        let { elements: t, rect: o, offsetParent: n, strategy: s } = e,
            l = s === 'fixed',
            i = A(n),
            r = t ? I(t.floating) : !1;
        if (n === i || (r && l)) return o;
        ...
        let h = i && !u && !l ? Oe(i, c) : O(0);
        return {
            width: o.width * a.x,
            height: o.height * a.y,
            x: o.x * a.x - c.scrollLeft * a.x + d.x + h.x,
            y: o.y * a.y - c.scrollTop * a.y + d.y + h.y,
        };
    }
    function ze(e) {
    ...
    function Ie(e) {
        let t = A(e),
            ...
            s = k(t.scrollWidth, t.clientWidth, n.scrollWidth, n.clientWidth),
            l = k(
                t.scrollHeight,
                t.clientHeight,
                n.scrollHeight,
        ...
        return (
            C(n).direction === 'rtl' &&
                (i += k(t.clientWidth, n.clientWidth) - s),
            { width: s, height: l, x: i, y: r }
        );
    }
    var ye = 25;
    function Ue(e, t) {
        ...
        if (a <= 0) {
            let d = n.ownerDocument,
                ...
                f =
                    ...
                    0,
                m = Math.abs(n.clientWidth - u.clientWidth - f);
            m <= ye && (l -= m);
        } else a <= ye && (l += a);
        return { width: l, height: i, x: r, y: c };
    }
    function Xe(e, t) {
        let o = $(e, !0, t === 'fixed'),
            n = o.top + e.clientTop,
            ...
            l = T(e) ? W(e) : O(1),
            i = e.clientWidth * l.x,
            r = e.clientHeight * l.y,
            c = s * l.x,
            a = n * l.y;
        return { width: i, height: r, x: c, y: a };
    }
    function be(e, t, o) {
        let n;
    ...
    function je(e, t) {
        let o = t.get(e);
        if (o) return o;
        let n = V(e, [], !1).filter((r) => R(r) && F(r) !== 'body'),
            s = null,
    ...
    function Je(e, t, o) {
        ...
        if (n || (!n && !l))
            if (((F(t) !== 'body' || B(s)) && (r = U(t)), n)) {
                let f = $(t, !0, l, t);
                ((c.x = f.x + t.clientLeft), (c.y = f.y + t.clientTop));
            } else s && a();
        l && !n && s && a();
        let d = s && !n && !l ? Oe(s, r) : O(0),
            u = i.left + r.scrollLeft - c.x - d.x,
            h = i.top + r.scrollTop - c.y - d.y;
    ...
    var Ke = async function (e) {
        let t = this.getOffsetParent || Se,
            o = this.getDimensions,
            n = await o(e.floating);
        return {
    ...
    function Ze(e, t) {
        ...
        function i(r, c) {
            ...
            let a = e.getBoundingClientRect(),
                { left: d, top: u, width: h, height: f } = a;
            if ((r || t(), !h || !f)) return;
            let m = _(u),
                p = _(s.clientWidth - (d + h)),
                w = _(s.clientHeight - (u + f)),
                g = _(d),
                y = {
                    rootMargin:
                        -m + 'px ' + -p + 'px ' + -w + 'px ' + -g + 'px',
            ...
            try {
                ...
                o = new IntersectionObserver(L, y);
            }
            o.observe(e);
        }
        return (i(!0), l);
    ...
    function Le(e, t, o, n) {
        ...
        let {
            ...
            d = s || l ? [...(a ? V(a) : []), ...(t ? V(t) : [])] : [];
        d.forEach((g) => {
            (s && g.addEventListener('scroll', o, { passive: !0 }),
                l && g.addEventListener('resize', o));
        });
        let u = a && r ? Ze(a, o) : null,
            h = -1,
            f = null;
        i &&
        ...
        function w() {
            let g = $(e);
            (p && !Te(p, g) && o(), (p = g), (m = requestAnimationFrame(w)));
        }
        return (
            o(),
            () => {
                ...
                (d.forEach((x) => {
                    (s && x.removeEventListener('scroll', o),
                        l && x.removeEventListener('resize', o));
                }),
                    u?.(),
    ...
    var Pe = (e, t, o) => {
        let n = new Map(),
            s = { platform: Qe, ...o },
            l = { ...s.platform, _c: n };
        return de(e, t, { ...s, platform: l });
    };
    var De = ({
        areGroupsCollapsedByDefault: e,
        canTrackDeselectedRecords: t,
        currentSelectionLivewireProperty: o,
        maxSelectableRecords: n,
        selectsCurrentPageOnly: s,
        $wire: l,
    }) => ({
        areFiltersOpen: !1,
        ...
        mountAction(...i) {
            (l.set(
                ...
                l.set('selectedTableRecords', [...this.selectedRecords], !1),
                l.set(
        ...
        toggleSelectRecordsOnPage() {
            let i = this.getRecordsOnPage();
            if (this.areRecordsSelected(i)) {
                this.deselectRecords(i);
                return;
            }
            this.selectRecords(i);
        },
        toggleSelectRecords(i) {
            this.areRecordsSelected(i)
                ? this.deselectRecords(i)
                : this.selectRecords(i);
        },
        getSelectedRecordsCount() {
            return this.isTrackingDeselectedRecords
        ...
        getRecordsOnPage() {
            let i = [];
            for (let r of this.$root?.getElementsByClassName(
        ...
        selectRecords(i) {
            n === 1 && (this.deselectAllRecords(), (i = i.slice(0, 1)));
            for (let r of i)
                if (!this.isRecordSelected(r)) {
                    if (this.isTrackingDeselectedRecords) {
                        this.deselectedRecords.delete(r);
                        continue;
                    }
        ...
        updatedSelectedRecords() {
            ...
            this.entangledSelectedRecords =
                [...this.selectedRecords][0] ?? null;
        },
        toggleSelectedRecord(i) {
        ...
        async selectAllRecords() {
            if (!t || s) {
                ((this.isLoading = !0),
                    (this.selectedRecords = new Set(
                        await l.getAllSelectableTableRecordKeys(),
                    )),
                    this.updatedSelectedRecords(),
                    (this.isLoading = !1));
                return;
            }
            ((this.isTrackingDeselectedRecords = !0),
                (this.selectedRecords = new Set()),
        ...
        canSelectAllRecords() {
            if (s) {
                let c = this.getRecordsOnPage();
                return (
                    !this.areRecordsSelected(c) && this.areRecordsToggleable(c)
                );
            }
            let i = parseInt(this.$refs.allSelectableRecordsCount?.value);
            if (!i) return !1;
            let r = this.getSelectedRecordsCount();
            return i === r ? !1 : n === null || i <= n;
        },
        deselectAllRecords() {
            ((this.isTrackingDeselectedRecords = !1),
                (this.selectedRecords = new Set()),
                (this.deselectedRecords = new Set()),
                this.updatedSelectedRecords());
        },
        isRecordSelected(i) {
            return this.isTrackingDeselectedRecords
                ? !this.deselectedRecords.has(i)
                : this.selectedRecords.has(i);
        },
        areRecordsSelected(i) {
            return i.every((r) => this.isRecordSelected(r));
        },
        areRecordsToggleable(i) {
            if (n === null || n === 1) return !0;
            let r = i.filter((c) => this.isRecordSelected(c));
            return r.length === i.length
                ? !0
                : this.getSelectedRecordsCount() + (i.length - r.length) <= n;
        },
        toggleCollapseGroup(i) {
            this.isGroupCollapsed(i)
                ? e
                    ? this.groupVisibility.push(i)
                    : this.groupVisibility.splice(
                          this.groupVisibility.indexOf(i),
                          1,
                      )
                : e
                  ? this.groupVisibility.splice(
        ...
        isGroupCollapsed(i) {
            return e
                ? !this.groupVisibility.includes(i)
                : this.groupVisibility.includes(i);
        },
        ...
        watchForCheckboxClicks() {
            ...
            let { signal: i } = this.checkboxClickController;
            this.$root?.addEventListener(
                'click',
                (r) =>
                    r.target?.matches('.fi-ta-record-checkbox') &&
                    this.handleCheckboxClick(r, r.target),
                { signal: i },
            );
        },
        handleCheckboxClick(i, r) {
            if (!this.lastChecked) {
                this.lastChecked = r;
                return;
            }
            if (i.shiftKey) {
                ...
                if (!c.includes(this.lastChecked)) {
                    this.lastChecked = r;
                    return;
                }
                let a = c.indexOf(this.lastChecked),
                    d = c.indexOf(r),
                    u = [a, d].sort((f, m) => f - m),
                    h = [];
                for (let f = u[0]; f <= u[1]; f++) h.push(c[f].value);
                if (r.checked) {
                    if (!this.areRecordsToggleable(h)) {
                        ((r.checked = !1), this.deselectRecords([r.value]));
                        return;
                    }
                    this.selectRecords(h);
                } else this.deselectRecords(h);
            }
            this.lastChecked = r;
        },
    ...
    function se({ columns: e, isLive: t }) {
        return {
            ...
            init() {
                ...
                ((this.deferredColumns = JSON.parse(
            ...
            get groupedColumns() {
                ...
                return (
                    this.deferredColumns
                        ...
                        .forEach((n) => {
                            o[n.name] = this.calculateGroupedColumns(n);
                        }),
                    o
                );
            },
            calculateGroupedColumns(o) {
                if ((o?.columns?.filter((r) => !r.isHidden) ?? []).length === 0)
                    return {
                        hidden: !0,
                        checked: !1,
                        disabled: !1,
                ...
                let s = o.columns.filter(
                    (r) => !r.isHidden && r.isToggleable !== !1,
                );
                if (s.length === 0)
                    return { checked: !0, disabled: !0, indeterminate: !1 };
                let l = s.filter((r) => r.isToggled).length,
                    i = o.columns.filter(
                        (r) => !r.isHidden && r.isToggleable === !1,
                    );
                return l === 0 && i.length > 0
                    ? { checked: !0, disabled: !1, indeterminate: !0 }
                    : l === 0
                      ? { checked: !1, disabled: !1, indeterminate: !1 }
                      : l === s.length
                        ? { checked: !0, disabled: !1, indeterminate: !1 }
                        : { checked: !0, disabled: !1, indeterminate: !0 };
            },
            getColumn(o, n = null) {
                return n
                    ? this.deferredColumns
                          .find((l) => l.type === 'group' && l.name === n)
                          ?.columns?.find((l) => l.name === o)
                    : this.deferredColumns.find((s) => s.name === o);
            },
            toggleGroup(o) {
                let n = this.deferredColumns.find(
                    (c) => c.type === 'group' && c.name === o,
                );
                if (!n?.columns) return;
                let s = this.calculateGroupedColumns(n);
                if (s.disabled) return;
                let i = n.columns
                        .filter((c) => c.isToggleable !== !1)
                        .some((c) => c.isToggled),
                    r = s.indeterminate ? !0 : !i;
                (n.columns
                    .filter((c) => c.isToggleable !== !1)
                    .forEach((c) => {
                        c.isToggled = r;
                    ...
                    this.isLive && this.applyTableColumnManager());
            },
            toggleColumn(o, n = null) {
                let s = this.getColumn(o, n);
                !s ||
                    s.isToggleable === !1 ||
            ...
            reorderColumns(o) {
                let n = o.map((s) => s.split('::'));
                (this.reorderTopLevel(n),
                    (this.hasReordered = !0),
                    this.isLive && this.applyTableColumnManager());
            },
            reorderGroupColumns(o, n) {
                let s = this.deferredColumns.find(
                    (r) => r.type === 'group' && r.name === n,
                );
                if (!s) return;
                let l = o.map((r) => r.split('::')),
                    i = [];
                (l.forEach(([r, c]) => {
                    let a = s.columns.find((d) => d.name === c);
                    a && i.push(a);
                }),
                    (s.columns = i),
                    (this.deferredColumns = [...this.deferredColumns]),
            ...
            reorderTopLevel(o) {
                let n = this.deferredColumns,
                    s = [];
                (o.forEach(([l, i]) => {
                    let r = n.find((c) =>
                        l === 'group'
                            ? c.type === 'group' && c.name === i
                            : l === 'column'
                              ? c.type !== 'group' && c.name === i
                              : !1,
                    );
                    ...
                    (this.deferredColumns = s));
            },
            async applyTableColumnManager() {
                this.isLoading = !0;
                try {
                    ((this.columns = JSON.parse(
                        JSON.stringify(this.deferredColumns),
                    )),
                    ...
                    ((this.error = 'Failed to update column visibility'),
                        console.error('Table toggle columns error:', o));
                } finally {
                    this.isLoading = !1;
                }
            },
    ...
    document.addEventListener('alpine:init', () => {
        (window.Alpine.data('filamentTable', De),
            window.Alpine.data('filamentTableColumnManager', se));
    });
})();
