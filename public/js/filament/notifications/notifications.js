(() => {
        ...
        e.data('notificationComponent', ({ notification: t }) => ({
            ...
            configureAnimations() {
                ...
                this.unsubscribeLivewireHook = Livewire.interceptMessage(
                    ({ onFinish: s, onSuccess: o }) => {
                        requestAnimationFrame(() => {
                            let r = () => this.$el.getBoundingClientRect().top,
                                n = r();
                            (s(() => {
                                ((i = () => {
                                    this.isShown &&
            ...
            close(i = !1) {
                ...
                setTimeout(s, this.transitionDuration);
            },
            markAsRead() {
                window.dispatchEvent(
    ...
    var h = class {
            ...
            view(t) {
                return ((this._view = t), this);
            }
            viewData(t) {
                return ((this._viewData = t), this);
            }
            toJSON() {
                return {
                    id: this._id,
                    title: this._title,
                    body: this._body,
                    actions: this._actions?.map((t) => t.toJSON()),
                    status: this._status,
                    color: this._color,
                    icon: this._icon,
        ...
        a = class {
            ...
            emitTo(t, i, s) {
                return (this.dispatchTo(t, i, s), this);
            }
            dispatchDirection(t) {
                return ((this._dispatchDirection = t), this);
            }
            dispatchToComponent(t) {
                return ((this._dispatchToComponent = t), this);
            }
            event(t) {
                return ((this._event = t), this);
            }
            eventData(t) {
                return ((this._eventData = t), this);
            }
            extraAttributes(t) {
                return ((this._extraAttributes = t), this);
            }
            icon(t) {
                return ((this._icon = t), this);
            }
            iconPosition(t) {
                return ((this._iconPosition = t), this);
            }
            outlined(t = !0) {
                return ((this._isOutlined = t), this);
            }
            disabled(t = !0) {
                return ((this._isDisabled = t), this);
            }
            label(t) {
                return ((this._label = t), this);
            }
            close(t = !0) {
                return ((this._shouldClose = t), this);
            }
            openUrlInNewTab(t = !0) {
                return ((this._shouldOpenUrlInNewTab = t), this);
            }
            size(t) {
            ...
            button() {
                return (this.view('filament::components.button.index'), this);
            }
            grouped() {
                return (
                    this.view('filament::components.dropdown.list.item'), this
                );
            }
            iconButton() {
                return (this.view('filament::components.icon-button'), this);
            }
            link() {
                return (this.view('filament::components.link'), this);
            }
            toJSON() {
                return {
                    name: this._name,
        ...
        u = class {
            ...
            actions(t) {
                return ((this._actions = t.map((i) => i.grouped())), this);
            }
            color(t) {
                return ((this._color = t), this);
            }
    ...
    window.FilamentNotificationAction = a;
    window.FilamentNotificationActionGroup = u;
    window.FilamentNotification = h;
