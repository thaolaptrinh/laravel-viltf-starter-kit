        ...
        i === void 0 && (i = {}),
        {
            ...
            async fn(t) {
                ...
                let q = [a, ...M],
                    ...
                    R = [],
                    W = ((n = s.flip) == null ? void 0 : n.overflows) || [];
                if ((f && R.push(J[D]), d)) {
                    let B = Qe(o, r, E);
                    R.push(J[B[0]], J[B[1]]);
                }
                if (
                    ((W = [...W, { placement: o, overflows: R }]),
                    !R.every((B) => B <= 0))
                ) {
                    var V, tt;
                    let B =
                            (((V = s.flip) == null ? void 0 : V.index) || 0) +
                            1,
                        Y = q[B];
                    if (
                        Y &&
                        (!(d === 'alignment' ? w !== ht(Y) : !1) ||
                            W.every((L) =>
                                ht(L.placement) === w ? L.overflows[0] > 0 : !0,
                            ))
                    )
                        return {
                            data: { index: B, overflows: W },
                            reset: { placement: Y },
                        };
                    let F =
                        (tt = W.filter(($) => $.overflows[0] <= 0).sort(
                            ($, L) => $.overflows[1] - L.overflows[1],
                        )[0]) == null
                            ? void 0
                            : tt.placement;
                    if (!F)
...
v.prototype = {
    ...
    _onDragOver: function (t) {
                ...
                ft(
                    {
                        ...
                        onMove: function (Ge, qi) {
                            return ue(I, e, h, o, Ge, k(Ge), t, qi);
                        },
                        changed: A,
                    },
                    et,
        ...
        function w(L) {
            return (
                x('dragOverCompleted', { insertion: L }),
                L &&
                ...
                !a.dragoverBubble &&
                    !t.rootEl &&
                    n !== document &&
                    (h.parentNode[G]._isOutsideThisEl(t.target), !L && Lt(t)),
        ...
        if (
            ...
            if (!E || ($n(t, p, this) && !E.animated)) {
                ...
                var M = Bt(e, 0, a, !0);
                if (M === h) return w(!1);
                if (((n = M), (s = k(n)), ue(I, e, h, o, n, s, t, !1) !== !1))
                ...
                var C = 0,
                    ...
                    W = p ? 'top' : 'left',
                    V = Ii(n, 'top', 'top') || Ii(h, 'top', 'top'),
                    tt = V ? V.scrollTop : void 0;
                (Pt !== n &&
                    ((q = s[W]), (Zt = !1), (fe = (!R && a.invertSwap) || J)),
                    (C = Kn(
                        t,
                        n,
                        s,
                ...
                if (C !== 0) {
                    var B = ot(h);
                    do ((B -= C), (z = _.children[B]));
                    while (z && (b(z, 'display') === 'none' || z === y));
                }
                if (C === 0 || z === n) return w(!1);
                ((Pt = n), (Qt = C));
                var Y = n.nextElementSibling,
                    F = !1;
                F = C === 1;
                var $ = ue(I, e, h, o, n, s, t, F);
                if ($ !== !1)
                    return (
                        ($ === 1 || $ === -1) && (F = $ === 1),
                        (Ve = !0),
                        ...
                        F && !Y
                            ? e.appendChild(h)
                            : n.parentNode.insertBefore(h, F ? Y : n),
                        V && Wi(V, 0, tt - V.scrollTop),
                        (_ = h.parentNode),
                        q !== void 0 && !fe && (ge = Math.abs(q - k(n)[W])),
                        A(),
                        w(!0)
                    );
            }
...
function $n(i, t, e) {
    var n = k(Ye(e.el, e.options.draggable)),
        o = zi(e.el, e.options, y),
        s = 10;
    return t
        ? i.clientX > o.right + s ||
...
function jn() {
    ...
    return (
        (i.prototype = {
            ...
            nulling: function () {
                ((xe = $e = Ut = Ke = jt = Be = Fe = null), (N.length = 0));
            },
...
var He = Hi(function (i, t, e, n) {
        if (t.scroll) {
            ...
            do {
                ...
                var tt =
                        M &&
                        (Math.abs(w - o) <= r && W + A < q) -
                            (Math.abs(D - o) <= r && !!W),
                    z =
                        C &&
                        (Math.abs(x - s) <= r && V + E < J) -
                            (Math.abs(m - s) <= r && !!V);
                if (!N[d]) for (var B = 0; B <= d; B++) N[B] || (N[B] = {});
                ((N[d].vx != tt || N[d].vy != z || N[d].el !== p) &&
                    ((N[d].el = p),
                    (N[d].vx = tt),
                    (N[d].vy = z),
...
var Ee = class {
    constructor({
        ...
        placeholder: z,
        position: B = null,
        searchableOptionFields: Y = ['label'],
        searchDebounce: F = 1e3,
        ...
        ((this.canOptionLabelsWrap = t),
            ...
            (this.originalOptions = JSON.parse(JSON.stringify(V))),
            (this.placeholder = z),
            (this.position = B),
            (this.searchableOptionFields = Array.isArray(Y) ? Y : ['label']),
            (this.searchDebounce = F),
