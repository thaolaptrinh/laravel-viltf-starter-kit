    ...
    v = (e) => (
        ...
        e.length < 6
            ? {
                  ...
                  a: e.length === 4 ? a(parseInt(e[3] + e[3], 16) / 255, 2) : 1,
              }
            : {
                  ...
                  a:
                      e.length === 8
                          ? a(parseInt(e.substring(6, 8), 16) / 255, 2)
                          : 1,
              }
    ),
    nt = (e, t = 'deg') => Number(e) * (at[t] || 1),
    it = (e) => {
        let r =
    ...
    update(t) {
        ((this.hsva = t),
            ...
            this.el.setAttribute(
                'aria-valuetext',
                `Saturation ${a(t.s)}%, Brightness ${a(t.v)}%`,
            ));
    }
    getMove(t, r) {
        return {
...
var C = class extends u {
    ...
    update(t) {
        ...
        (this.el.setAttribute('aria-valuenow', `${n}`),
            this.el.setAttribute('aria-valuetext', `${n}%`));
    }
    getMove(t, r) {
